...
class ScriptApi
{
    ...
    */
     ...
     *
     *
     * @param \BigCommerce\Api\Model\ScriptPost $script_body  (required)
     * @param array $params = []
     * @return \BigCommerce\Api\Model\ScriptResponse
     * @throws \BigCommerce\Api\ApiException on non-2xx response
     * @throws \InvalidArgumentException
     */
    public function createScript($script_body, array $params = [])
    {
        list($response) = $this->createScriptWithHttpInfo( $script_body, $params);
        return $response;
    }
     ...
     *
     * @see self::createScript()
     * @param \BigCommerce\Api\Model\ScriptPost $script_body  (required)
     * @param array $params = []
     * @throws \BigCommerce\Api\ApiException on non-2xx response
     * @throws \InvalidArgumentException
     * @return array of \BigCommerce\Api\Model\ScriptResponse, HTTP status code, HTTP response headers (array of strings)
     */
    public function createScriptWithHttpInfo( $script_body, array $params = [])
    {
        ...
        try {
            list($response, $statusCode, $httpHeader) = $this->apiClient->callApi(
                ...
                $httpBody,
                $headerParams,
                '\BigCommerce\Api\Model\ScriptResponse',
                '/content/scripts'
            );
            return [$this->apiClient->getSerializer()->deserialize($response, '\BigCommerce\Api\Model\ScriptResponse', $httpHeader), $statusCode, $httpHeader];

         } catch (ApiException $e) {
            switch ($e->getCode()) {
            
                case 200:
                $data = $this->apiClient->getSerializer()->deserialize($e->getResponseBody(), '\BigCommerce\Api\Model\ScriptResponse', $e->getResponseHeaders());
     ...
     * @throws \InvalidArgumentException
     */
    public function deleteScript($uuid, array $params = [])
    {
        list($response) = $this->deleteScriptWithHttpInfo($uuid, $params);
        return $response;
    }
     ...
     */
    public function deleteScriptWithHttpInfo($uuid, array $params = [])
    {
     ...
     * @throws \InvalidArgumentException
     */
    public function getScript($uuid, array $params = [])
    {
        list($response) = $this->getScriptWithHttpInfo($uuid, $params);
        return $response;
    }
     ...
     * @return array of \BigCommerce\Api\Model\ScriptResponse, HTTP status code, HTTP response headers (array of strings)
     */
    public function getScriptWithHttpInfo($uuid, array $params = [])
    {
     ...
     * @return \BigCommerce\Api\Model\ScriptsResponse
     * @throws \BigCommerce\Api\ApiException on non-2xx response
     * @throws \InvalidArgumentException
     */
    public function getScripts(array $params = [])
    {
        list($response) = $this->getScriptsWithHttpInfo($params);
        return $response;
    }
     ...
     * @throws \BigCommerce\Api\ApiException on non-2xx response
     * @throws \InvalidArgumentException
     * @return array of \BigCommerce\Api\Model\ScriptsResponse, HTTP status code, HTTP response headers (array of strings)
     */
    public function getScriptsWithHttpInfo(array $params = [])
    {
        ...
        try {
            list($response, $statusCode, $httpHeader) = $this->apiClient->callApi(
                ...
                $httpBody,
                $headerParams,
                '\BigCommerce\Api\Model\ScriptsResponse',
                '/content/scripts'
            );
            return [$this->apiClient->getSerializer()->deserialize($response, '\BigCommerce\Api\Model\ScriptsResponse', $httpHeader), $statusCode, $httpHeader];

         } catch (ApiException $e) {
            switch ($e->getCode()) {
            
                case 200:
                $data = $this->apiClient->getSerializer()->deserialize($e->getResponseBody(), '\BigCommerce\Api\Model\ScriptsResponse', $e->getResponseHeaders());
                $e->setResponseObject($data);
                break;
     ...
     *
     * @param string $uuid The identifier for a specific script. (required)
     * @param \BigCommerce\Api\Model\ScriptPut $script_body  (required)
     * @param array $params = []
     * @return \BigCommerce\Api\Model\ScriptResponse
     * @throws \BigCommerce\Api\ApiException on non-2xx response
     * @throws \InvalidArgumentException
     */
    public function updateScript($uuid, $script_body, array $params = [])
    {
        list($response) = $this->updateScriptWithHttpInfo($uuid,  $script_body, $params);
        return $response;
    }
     ...
     * @return array of \BigCommerce\Api\Model\ScriptResponse, HTTP status code, HTTP response headers (array of strings)
     */
    public function updateScriptWithHttpInfo($uuid,  $script_body, array $params = [])
    {
