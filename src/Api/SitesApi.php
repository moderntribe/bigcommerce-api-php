...
class SitesApi
{
    ...
    */
     ...
     * @param array $params = []
     * @return \BigCommerce\Api\Model\SiteResponse
     * @throws \BigCommerce\Api\ApiException on non-2xx response
     * @throws \InvalidArgumentException
     */
     ...
     * @throws \BigCommerce\Api\ApiException on non-2xx response
     * @throws \InvalidArgumentException
     * @return array of \BigCommerce\Api\Model\SiteResponse, HTTP status code, HTTP response headers (array of strings)
     */
    public function getChannelSiteWithHttpInfo($channel_id, array $params = [])
    {
        ...
        try {
            list($response, $statusCode, $httpHeader) = $this->apiClient->callApi(
                ...
                $httpBody,
                $headerParams,
                '\BigCommerce\Api\Model\SiteResponse',
                '/channels/{channel_id}/site'
            );
            return [$this->apiClient->getSerializer()->deserialize($response, '\BigCommerce\Api\Model\SiteResponse', $httpHeader), $statusCode, $httpHeader];

         } catch (ApiException $e) {
            switch ($e->getCode()) {
            
                case 200:
                $data = $this->apiClient->getSerializer()->deserialize($e->getResponseBody(), '\BigCommerce\Api\Model\SiteResponse', $e->getResponseHeaders());
     ...
     * @param string $id  (required)
     * @param array $params = []
     * @return \BigCommerce\Api\Model\RouteResponse
     * @throws \BigCommerce\Api\ApiException on non-2xx response
     * @throws \InvalidArgumentException
     */
     ...
     * @throws \BigCommerce\Api\ApiException on non-2xx response
     * @throws \InvalidArgumentException
     * @return array of \BigCommerce\Api\Model\RouteResponse, HTTP status code, HTTP response headers (array of strings)
     */
    public function getSiteRouteWithHttpInfo($site_id, $id, array $params = [])
    {
        ...
        try {
            list($response, $statusCode, $httpHeader) = $this->apiClient->callApi(
                ...
                $httpBody,
                $headerParams,
                '\BigCommerce\Api\Model\RouteResponse',
                '/sites/{site_id}/routes/{id}'
            );
            return [$this->apiClient->getSerializer()->deserialize($response, '\BigCommerce\Api\Model\RouteResponse', $httpHeader), $statusCode, $httpHeader];

         } catch (ApiException $e) {
            switch ($e->getCode()) {
            
                case 200:
                $data = $this->apiClient->getSerializer()->deserialize($e->getResponseBody(), '\BigCommerce\Api\Model\RouteResponse', $e->getResponseHeaders());
                $e->setResponseObject($data);
                break;
     ...
     * @return \BigCommerce\Api\Model\RouteCollectionResponse
     * @throws \BigCommerce\Api\ApiException on non-2xx response
     * @throws \InvalidArgumentException
     */
     ...
     * @throws \BigCommerce\Api\ApiException on non-2xx response
     * @throws \InvalidArgumentException
     * @return array of \BigCommerce\Api\Model\RouteCollectionResponse, HTTP status code, HTTP response headers (array of strings)
     */
    public function indexSiteRoutesWithHttpInfo($site_id, array $params = [])
    {
        ...
        try {
            list($response, $statusCode, $httpHeader) = $this->apiClient->callApi(
                ...
                $httpBody,
                $headerParams,
                '\BigCommerce\Api\Model\RouteCollectionResponse',
                '/sites/{site_id}/routes'
            );
            return [$this->apiClient->getSerializer()->deserialize($response, '\BigCommerce\Api\Model\RouteCollectionResponse', $httpHeader), $statusCode, $httpHeader];

         } catch (ApiException $e) {
            switch ($e->getCode()) {
            
                case 200:
                $data = $this->apiClient->getSerializer()->deserialize($e->getResponseBody(), '\BigCommerce\Api\Model\RouteCollectionResponse', $e->getResponseHeaders());
                $e->setResponseObject($data);
                break;
     ...
     *
     * @param string $channel_id  (required)
     * @param \BigCommerce\Api\Model\SiteCreateRequest $body  (required)
     * @param array $params = []
     * @return \BigCommerce\Api\Model\SiteResponse
     * @throws \BigCommerce\Api\ApiException on non-2xx response
     * @throws \InvalidArgumentException
     ...
     *
     * @param string $site_id  (required)
     * @param \BigCommerce\Api\Model\Route $body  (required)
     * @param array $params = []
     * @return \BigCommerce\Api\Model\RouteResponse
     * @throws \BigCommerce\Api\ApiException on non-2xx response
     * @throws \InvalidArgumentException
     ...
     *
     * @param string $channel_id  (required)
     * @param \BigCommerce\Api\Model\Site $body  (required)
     * @param array $params = []
     * @return \BigCommerce\Api\Model\SiteResponse
     * @throws \BigCommerce\Api\ApiException on non-2xx response
     * @throws \InvalidArgumentException
