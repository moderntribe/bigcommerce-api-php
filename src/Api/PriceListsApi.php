...
class PriceListsApi
{
    ...
    */
     ...
     *
     *
     * @param \BigCommerce\Api\Model\PriceListPost $price_list A BigCommerce &#x60;PriceList&#x60; object. (required)
     * @param array $params = []
     * @return \BigCommerce\Api\Model\PriceListResponse
     ...
     * @throws \BigCommerce\Api\ApiException on non-2xx response
     * @throws \InvalidArgumentException
     * @return array of \BigCommerce\Api\Model\PriceListResponse, HTTP status code, HTTP response headers (array of strings)
     */
    public function createPriceListWithHttpInfo( $price_list, array $params = [])
    {
        ...
        try {
            list($response, $statusCode, $httpHeader) = $this->apiClient->callApi(
                ...
                $httpBody,
                $headerParams,
                '\BigCommerce\Api\Model\PriceListResponse',
                '/pricelists'
            );
            return [$this->apiClient->getSerializer()->deserialize($response, '\BigCommerce\Api\Model\PriceListResponse', $httpHeader), $statusCode, $httpHeader];

         } catch (ApiException $e) {
            switch ($e->getCode()) {
            
                case 200:
                $data = $this->apiClient->getSerializer()->deserialize($e->getResponseBody(), '\BigCommerce\Api\Model\PriceListResponse', $e->getResponseHeaders());
     ...
     * @return \BigCommerce\Api\Model\PriceListCollectionResponse
     * @throws \BigCommerce\Api\ApiException on non-2xx response
     * @throws \InvalidArgumentException
     */
     ...
     * @throws \BigCommerce\Api\ApiException on non-2xx response
     * @throws \InvalidArgumentException
     * @return array of \BigCommerce\Api\Model\PriceListCollectionResponse, HTTP status code, HTTP response headers (array of strings)
     */
    public function getPriceListCollectionWithHttpInfo(array $params = [])
    {
        ...
        try {
            list($response, $statusCode, $httpHeader) = $this->apiClient->callApi(
                ...
                $httpBody,
                $headerParams,
                '\BigCommerce\Api\Model\PriceListCollectionResponse',
                '/pricelists'
            );
            return [$this->apiClient->getSerializer()->deserialize($response, '\BigCommerce\Api\Model\PriceListCollectionResponse', $httpHeader), $statusCode, $httpHeader];

         } catch (ApiException $e) {
            switch ($e->getCode()) {
            
                case 200:
                $data = $this->apiClient->getSerializer()->deserialize($e->getResponseBody(), '\BigCommerce\Api\Model\PriceListCollectionResponse', $e->getResponseHeaders());
                $e->setResponseObject($data);
                break;
     ...
     * @return \BigCommerce\Api\Model\PriceRecordResponse
     * @throws \BigCommerce\Api\ApiException on non-2xx response
     * @throws \InvalidArgumentException
     */
     ...
     * @throws \BigCommerce\Api\ApiException on non-2xx response
     * @throws \InvalidArgumentException
     * @return array of \BigCommerce\Api\Model\PriceRecordResponse, HTTP status code, HTTP response headers (array of strings)
     */
    public function getPriceListRecordWithHttpInfo($price_list_id, $variant_id, $currency_code, array $params = [])
    {
        ...
        try {
            list($response, $statusCode, $httpHeader) = $this->apiClient->callApi(
                ...
                $httpBody,
                $headerParams,
                '\BigCommerce\Api\Model\PriceRecordResponse',
                '/pricelists/{price_list_id}/records/{variant_id}/{currency_code}'
            );
            return [$this->apiClient->getSerializer()->deserialize($response, '\BigCommerce\Api\Model\PriceRecordResponse', $httpHeader), $statusCode, $httpHeader];

         } catch (ApiException $e) {
            switch ($e->getCode()) {
            
                case 200:
                $data = $this->apiClient->getSerializer()->deserialize($e->getResponseBody(), '\BigCommerce\Api\Model\PriceRecordResponse', $e->getResponseHeaders());
                $e->setResponseObject($data);
                break;
     ...
     * @return \BigCommerce\Api\Model\PriceRecordCollectionResponse
     * @throws \BigCommerce\Api\ApiException on non-2xx response
     * @throws \InvalidArgumentException
     */
     ...
     * @throws \BigCommerce\Api\ApiException on non-2xx response
     * @throws \InvalidArgumentException
     * @return array of \BigCommerce\Api\Model\PriceRecordCollectionResponse, HTTP status code, HTTP response headers (array of strings)
     */
    public function getPriceListRecordCollectionWithHttpInfo($price_list_id, array $params = [])
    {
        ...
        try {
            list($response, $statusCode, $httpHeader) = $this->apiClient->callApi(
                ...
                $httpBody,
                $headerParams,
                '\BigCommerce\Api\Model\PriceRecordCollectionResponse',
                '/pricelists/{price_list_id}/records'
            );
            return [$this->apiClient->getSerializer()->deserialize($response, '\BigCommerce\Api\Model\PriceRecordCollectionResponse', $httpHeader), $statusCode, $httpHeader];

         } catch (ApiException $e) {
            switch ($e->getCode()) {
            
                case 200:
                $data = $this->apiClient->getSerializer()->deserialize($e->getResponseBody(), '\BigCommerce\Api\Model\PriceRecordCollectionResponse', $e->getResponseHeaders());
                $e->setResponseObject($data);
                break;
     ...
     * @param int $variant_id ID of the variant on a product, or on an associated Price List Record. (required)
     * @param string $currency_code The currency code associated with the price record being acted upon. (required)
     * @param \BigCommerce\Api\Model\PriceRecordPut $price_record A BigCommerce &#x60;Price Record&#x60; object. (required)
     * @param array $params = []
     * @return \BigCommerce\Api\Model\PriceRecordResponse
     * @throws \BigCommerce\Api\ApiException on non-2xx response
     * @throws \InvalidArgumentException
     ...
     *
     * @param int $price_list_id The ID of the &#x60;Price List&#x60; requested. (required)
     * @param \BigCommerce\Api\Model\PriceRecordCollectionPut $price_record_batch A BigCommerce &#x60;Price Record&#x60; request. (required)
     * @param array $params = []
     * @return \BigCommerce\Api\Model\SuccessBatchResponse
     * @throws \BigCommerce\Api\ApiException on non-2xx response
     * @throws \InvalidArgumentException
     */
     ...
     * @throws \BigCommerce\Api\ApiException on non-2xx response
     * @throws \InvalidArgumentException
     * @return array of \BigCommerce\Api\Model\SuccessBatchResponse, HTTP status code, HTTP response headers (array of strings)
     */
    public function setPriceListRecordCollectionWithHttpInfo($price_list_id,  $price_record_batch, array $params = [])
    {
        ...
        try {
            list($response, $statusCode, $httpHeader) = $this->apiClient->callApi(
                ...
                $httpBody,
                $headerParams,
                '\BigCommerce\Api\Model\SuccessBatchResponse',
                '/pricelists/{price_list_id}/records'
            );
            return [$this->apiClient->getSerializer()->deserialize($response, '\BigCommerce\Api\Model\SuccessBatchResponse', $httpHeader), $statusCode, $httpHeader];

         } catch (ApiException $e) {
            switch ($e->getCode()) {
            
                case 200:
                $data = $this->apiClient->getSerializer()->deserialize($e->getResponseBody(), '\BigCommerce\Api\Model\SuccessBatchResponse', $e->getResponseHeaders());
                $e->setResponseObject($data);
                break;
            
                case 422:
                $data = $this->apiClient->getSerializer()->deserialize($e->getResponseBody(), '\BigCommerce\Api\Model\PriceRecordBatchErrorResponse', $e->getResponseHeaders());
                $e->setResponseObject($data);
                break;
     ...
     *
     * @param int $price_list_id The ID of the &#x60;Price List&#x60; requested. (required)
     * @param \BigCommerce\Api\Model\PriceListPut $price_list A BigCommerce &#x60;Price List&#x60; object. (required)
     * @param array $params = []
     * @return \BigCommerce\Api\Model\PriceListResponse
     * @throws \BigCommerce\Api\ApiException on non-2xx response
     * @throws \InvalidArgumentException
