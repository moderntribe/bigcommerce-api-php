...
class SubscribersApi
{
    ...
    */
     ...
     *
     *
     * @param \BigCommerce\Api\Model\SubscriberPost $subscriber &#x60;Subscriber&#x60; object. (required)
     * @param array $params = []
     * @return \BigCommerce\Api\Model\SubscriberResponse
     ...
     * @throws \BigCommerce\Api\ApiException on non-2xx response
     * @throws \InvalidArgumentException
     * @return array of \BigCommerce\Api\Model\SubscriberResponse, HTTP status code, HTTP response headers (array of strings)
     */
    public function createSubscriberWithHttpInfo( $subscriber, array $params = [])
    {
        ...
        try {
            list($response, $statusCode, $httpHeader) = $this->apiClient->callApi(
                ...
                $httpBody,
                $headerParams,
                '\BigCommerce\Api\Model\SubscriberResponse',
                '/customers/subscribers'
            );
            return [$this->apiClient->getSerializer()->deserialize($response, '\BigCommerce\Api\Model\SubscriberResponse', $httpHeader), $statusCode, $httpHeader];

         } catch (ApiException $e) {
            switch ($e->getCode()) {
            
                case 200:
                $data = $this->apiClient->getSerializer()->deserialize($e->getResponseBody(), '\BigCommerce\Api\Model\SubscriberResponse', $e->getResponseHeaders());
     ...
     * @return \BigCommerce\Api\Model\SubscriberCollectionResponse
     * @throws \BigCommerce\Api\ApiException on non-2xx response
     * @throws \InvalidArgumentException
     */
     ...
     * @throws \BigCommerce\Api\ApiException on non-2xx response
     * @throws \InvalidArgumentException
     * @return array of \BigCommerce\Api\Model\SubscriberCollectionResponse, HTTP status code, HTTP response headers (array of strings)
     */
    public function getSubscribersWithHttpInfo(array $params = [])
    {
        ...
        try {
            list($response, $statusCode, $httpHeader) = $this->apiClient->callApi(
                ...
                $httpBody,
                $headerParams,
                '\BigCommerce\Api\Model\SubscriberCollectionResponse',
                '/customers/subscribers'
            );
            return [$this->apiClient->getSerializer()->deserialize($response, '\BigCommerce\Api\Model\SubscriberCollectionResponse', $httpHeader), $statusCode, $httpHeader];

         } catch (ApiException $e) {
            switch ($e->getCode()) {
            
                case 200:
                $data = $this->apiClient->getSerializer()->deserialize($e->getResponseBody(), '\BigCommerce\Api\Model\SubscriberCollectionResponse', $e->getResponseHeaders());
                $e->setResponseObject($data);
                break;
     ...
     *
     * @param int $subscriber_id The ID of the &#x60;Subscriber&#x60; requested. (required)
     * @param \BigCommerce\Api\Model\SubscriberPut $subscriber Returns a &#x60;Subscriber&#x60; object. (required)
     * @param array $params = []
     * @return \BigCommerce\Api\Model\SubscriberResponse
     * @throws \BigCommerce\Api\ApiException on non-2xx response
     * @throws \InvalidArgumentException
