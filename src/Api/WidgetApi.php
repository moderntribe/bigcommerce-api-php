...
class WidgetApi
{
    ...
    */
     ...
     *
     *
     * @param \BigCommerce\Api\Model\LayoutRequest $body  (required)
     * @param array $params = []
     * @return \BigCommerce\Api\Model\LayoutResponse
     ...
     * @throws \BigCommerce\Api\ApiException on non-2xx response
     * @throws \InvalidArgumentException
     * @return array of \BigCommerce\Api\Model\LayoutResponse, HTTP status code, HTTP response headers (array of strings)
     */
    public function createLayoutWithHttpInfo( $body, array $params = [])
    {
        ...
        try {
            list($response, $statusCode, $httpHeader) = $this->apiClient->callApi(
                ...
                $httpBody,
                $headerParams,
                '\BigCommerce\Api\Model\LayoutResponse',
                '/content/layouts'
            );
            return [$this->apiClient->getSerializer()->deserialize($response, '\BigCommerce\Api\Model\LayoutResponse', $httpHeader), $statusCode, $httpHeader];

         } catch (ApiException $e) {
            switch ($e->getCode()) {
            
                case 200:
                $data = $this->apiClient->getSerializer()->deserialize($e->getResponseBody(), '\BigCommerce\Api\Model\LayoutResponse', $e->getResponseHeaders());
     ...
     *
     *
     * @param \BigCommerce\Api\Model\PlacementRequest $body  (required)
     * @param array $params = []
     * @return \BigCommerce\Api\Model\PlacementResponse
     * @throws \BigCommerce\Api\ApiException on non-2xx response
     * @throws \InvalidArgumentException
     */
     ...
     * @throws \BigCommerce\Api\ApiException on non-2xx response
     * @throws \InvalidArgumentException
     * @return array of \BigCommerce\Api\Model\PlacementResponse, HTTP status code, HTTP response headers (array of strings)
     */
    public function createPlacementWithHttpInfo( $body, array $params = [])
    {
        ...
        try {
            list($response, $statusCode, $httpHeader) = $this->apiClient->callApi(
                ...
                $httpBody,
                $headerParams,
                '\BigCommerce\Api\Model\PlacementResponse',
                '/content/placements'
            );
            return [$this->apiClient->getSerializer()->deserialize($response, '\BigCommerce\Api\Model\PlacementResponse', $httpHeader), $statusCode, $httpHeader];

         } catch (ApiException $e) {
            switch ($e->getCode()) {
            
                case 200:
                $data = $this->apiClient->getSerializer()->deserialize($e->getResponseBody(), '\BigCommerce\Api\Model\PlacementResponse', $e->getResponseHeaders());
                $e->setResponseObject($data);
                break;
     ...
     *
     *
     * @param \BigCommerce\Api\Model\WidgetRequest $body  (required)
     * @param array $params = []
     * @return \BigCommerce\Api\Model\WidgetResponse
     * @throws \BigCommerce\Api\ApiException on non-2xx response
     * @throws \InvalidArgumentException
     */
     ...
     * @throws \BigCommerce\Api\ApiException on non-2xx response
     * @throws \InvalidArgumentException
     * @return array of \BigCommerce\Api\Model\WidgetResponse, HTTP status code, HTTP response headers (array of strings)
     */
    public function createWidgetWithHttpInfo( $body, array $params = [])
    {
        ...
        try {
            list($response, $statusCode, $httpHeader) = $this->apiClient->callApi(
                ...
                $httpBody,
                $headerParams,
                '\BigCommerce\Api\Model\WidgetResponse',
                '/content/widgets'
            );
            return [$this->apiClient->getSerializer()->deserialize($response, '\BigCommerce\Api\Model\WidgetResponse', $httpHeader), $statusCode, $httpHeader];

         } catch (ApiException $e) {
            switch ($e->getCode()) {
            
                case 200:
                $data = $this->apiClient->getSerializer()->deserialize($e->getResponseBody(), '\BigCommerce\Api\Model\WidgetResponse', $e->getResponseHeaders());
                $e->setResponseObject($data);
                break;
     ...
     *
     *
     * @param \BigCommerce\Api\Model\WidgetTemplateRequest $body  (required)
     * @param array $params = []
     * @return \BigCommerce\Api\Model\WidgetTemplateResponse
     * @throws \BigCommerce\Api\ApiException on non-2xx response
     * @throws \InvalidArgumentException
     */
     ...
     * @throws \BigCommerce\Api\ApiException on non-2xx response
     * @throws \InvalidArgumentException
     * @return array of \BigCommerce\Api\Model\WidgetTemplateResponse, HTTP status code, HTTP response headers (array of strings)
     */
    public function createWidgetTemplateWithHttpInfo( $body, array $params = [])
    {
        ...
        try {
            list($response, $statusCode, $httpHeader) = $this->apiClient->callApi(
                ...
                $httpBody,
                $headerParams,
                '\BigCommerce\Api\Model\WidgetTemplateResponse',
                '/content/widget-templates'
            );
            return [$this->apiClient->getSerializer()->deserialize($response, '\BigCommerce\Api\Model\WidgetTemplateResponse', $httpHeader), $statusCode, $httpHeader];

         } catch (ApiException $e) {
            switch ($e->getCode()) {
            
                case 200:
                $data = $this->apiClient->getSerializer()->deserialize($e->getResponseBody(), '\BigCommerce\Api\Model\WidgetTemplateResponse', $e->getResponseHeaders());
                $e->setResponseObject($data);
                break;
     ...
     * @return \BigCommerce\Api\Model\ThemeRegionsCollectionResponse
     * @throws \BigCommerce\Api\ApiException on non-2xx response
     * @throws \InvalidArgumentException
     */
     ...
     * @throws \BigCommerce\Api\ApiException on non-2xx response
     * @throws \InvalidArgumentException
     * @return array of \BigCommerce\Api\Model\ThemeRegionsCollectionResponse, HTTP status code, HTTP response headers (array of strings)
     */
    public function getContentRegionsWithHttpInfo(array $params = [])
    {
        ...
        try {
            list($response, $statusCode, $httpHeader) = $this->apiClient->callApi(
                ...
                $httpBody,
                $headerParams,
                '\BigCommerce\Api\Model\ThemeRegionsCollectionResponse',
                '/content/regions'
            );
            return [$this->apiClient->getSerializer()->deserialize($response, '\BigCommerce\Api\Model\ThemeRegionsCollectionResponse', $httpHeader), $statusCode, $httpHeader];

         } catch (ApiException $e) {
            switch ($e->getCode()) {
            
                case 200:
                $data = $this->apiClient->getSerializer()->deserialize($e->getResponseBody(), '\BigCommerce\Api\Model\ThemeRegionsCollectionResponse', $e->getResponseHeaders());
                $e->setResponseObject($data);
                break;
     ...
     * @return \BigCommerce\Api\Model\LayoutCollectionResponse
     * @throws \BigCommerce\Api\ApiException on non-2xx response
     * @throws \InvalidArgumentException
     */
     ...
     * @throws \BigCommerce\Api\ApiException on non-2xx response
     * @throws \InvalidArgumentException
     * @return array of \BigCommerce\Api\Model\LayoutCollectionResponse, HTTP status code, HTTP response headers (array of strings)
     */
    public function getLayoutsWithHttpInfo(array $params = [])
    {
        ...
        try {
            list($response, $statusCode, $httpHeader) = $this->apiClient->callApi(
                ...
                $httpBody,
                $headerParams,
                '\BigCommerce\Api\Model\LayoutCollectionResponse',
                '/content/layouts'
            );
            return [$this->apiClient->getSerializer()->deserialize($response, '\BigCommerce\Api\Model\LayoutCollectionResponse', $httpHeader), $statusCode, $httpHeader];

         } catch (ApiException $e) {
            switch ($e->getCode()) {
            
                case 200:
                $data = $this->apiClient->getSerializer()->deserialize($e->getResponseBody(), '\BigCommerce\Api\Model\LayoutCollectionResponse', $e->getResponseHeaders());
                $e->setResponseObject($data);
                break;
     ...
     * @return \BigCommerce\Api\Model\PlacementsCollectionResponse
     * @throws \BigCommerce\Api\ApiException on non-2xx response
     * @throws \InvalidArgumentException
     */
     ...
     * @throws \BigCommerce\Api\ApiException on non-2xx response
     * @throws \InvalidArgumentException
     * @return array of \BigCommerce\Api\Model\PlacementsCollectionResponse, HTTP status code, HTTP response headers (array of strings)
     */
    public function getPlacementsWithHttpInfo(array $params = [])
    {
        ...
        try {
            list($response, $statusCode, $httpHeader) = $this->apiClient->callApi(
                ...
                $httpBody,
                $headerParams,
                '\BigCommerce\Api\Model\PlacementsCollectionResponse',
                '/content/placements'
            );
            return [$this->apiClient->getSerializer()->deserialize($response, '\BigCommerce\Api\Model\PlacementsCollectionResponse', $httpHeader), $statusCode, $httpHeader];

         } catch (ApiException $e) {
            switch ($e->getCode()) {
            
                case 200:
                $data = $this->apiClient->getSerializer()->deserialize($e->getResponseBody(), '\BigCommerce\Api\Model\PlacementsCollectionResponse', $e->getResponseHeaders());
                $e->setResponseObject($data);
                break;
     ...
     *     - limit int Controls the number of items per page in a limited (paginated) list of products. (optional)
     *     - widget_template_kind string The kind of widget template. (optional)
     * @return \BigCommerce\Api\Model\WidgetTemplatesCollectionResponse
     * @throws \BigCommerce\Api\ApiException on non-2xx response
     * @throws \InvalidArgumentException
     */
     ...
     * @throws \BigCommerce\Api\ApiException on non-2xx response
     * @throws \InvalidArgumentException
     * @return array of \BigCommerce\Api\Model\WidgetTemplatesCollectionResponse, HTTP status code, HTTP response headers (array of strings)
     */
    public function getWidgetTemplatesWithHttpInfo(array $params = [])
    {
        ...
        try {
            list($response, $statusCode, $httpHeader) = $this->apiClient->callApi(
                ...
                $httpBody,
                $headerParams,
                '\BigCommerce\Api\Model\WidgetTemplatesCollectionResponse',
                '/content/widget-templates'
            );
            return [$this->apiClient->getSerializer()->deserialize($response, '\BigCommerce\Api\Model\WidgetTemplatesCollectionResponse', $httpHeader), $statusCode, $httpHeader];

         } catch (ApiException $e) {
            switch ($e->getCode()) {
            
                case 200:
                $data = $this->apiClient->getSerializer()->deserialize($e->getResponseBody(), '\BigCommerce\Api\Model\WidgetTemplatesCollectionResponse', $e->getResponseHeaders());
                $e->setResponseObject($data);
                break;
     ...
     *     - widget_template_kind string The kind of widget template. (optional)
     *     - widget_template_uuid string The identifier for a specific widget template. (optional)
     * @return \BigCommerce\Api\Model\WidgetCollectionResponse
     * @throws \BigCommerce\Api\ApiException on non-2xx response
     * @throws \InvalidArgumentException
     */
     ...
     * @throws \BigCommerce\Api\ApiException on non-2xx response
     * @throws \InvalidArgumentException
     * @return array of \BigCommerce\Api\Model\WidgetCollectionResponse, HTTP status code, HTTP response headers (array of strings)
     */
    public function getWidgetsWithHttpInfo(array $params = [])
    {
        ...
        try {
            list($response, $statusCode, $httpHeader) = $this->apiClient->callApi(
                ...
                $httpBody,
                $headerParams,
                '\BigCommerce\Api\Model\WidgetCollectionResponse',
                '/content/widgets'
            );
            return [$this->apiClient->getSerializer()->deserialize($response, '\BigCommerce\Api\Model\WidgetCollectionResponse', $httpHeader), $statusCode, $httpHeader];

         } catch (ApiException $e) {
            switch ($e->getCode()) {
            
                case 200:
                $data = $this->apiClient->getSerializer()->deserialize($e->getResponseBody(), '\BigCommerce\Api\Model\WidgetCollectionResponse', $e->getResponseHeaders());
                $e->setResponseObject($data);
                break;
     ...
     *
     * @param string $uuid The identifier for a specific layout. (required)
     * @param \BigCommerce\Api\Model\LayoutRequest $layout_body  (required)
     * @param array $params = []
     * @return \BigCommerce\Api\Model\LayoutResponse
     * @throws \BigCommerce\Api\ApiException on non-2xx response
     * @throws \InvalidArgumentException
     ...
     *
     * @param string $uuid The identifier for a specific placement. (required)
     * @param \BigCommerce\Api\Model\PlacementRequest $placement_body  (required)
     * @param array $params = []
     * @return \BigCommerce\Api\Model\PlacementResponse
     * @throws \BigCommerce\Api\ApiException on non-2xx response
     * @throws \InvalidArgumentException
