...
class CatalogApi
{
    ...
    */
     ...
     *
     * @param array $params = []
     * @return \BigCommerce\Api\Model\CatalogSummaryResponse
     ...
     * @throws \BigCommerce\Api\ApiException on non-2xx response
     * @throws \InvalidArgumentException
     * @return array of \BigCommerce\Api\Model\CatalogSummaryResponse, HTTP status code, HTTP response headers (array of strings)
     */
    public function catalogSummaryGetWithHttpInfo(array $params = [])
    {
        ...
        try {
            list($response, $statusCode, $httpHeader) = $this->apiClient->callApi(
                ...
                $httpBody,
                $headerParams,
                '\BigCommerce\Api\Model\CatalogSummaryResponse',
                '/catalog/summary'
            );
            return [$this->apiClient->getSerializer()->deserialize($response, '\BigCommerce\Api\Model\CatalogSummaryResponse', $httpHeader), $statusCode, $httpHeader];

         } catch (ApiException $e) {
            switch ($e->getCode()) {
            
                case 200:
                $data = $this->apiClient->getSerializer()->deserialize($e->getResponseBody(), '\BigCommerce\Api\Model\CatalogSummaryResponse', $e->getResponseHeaders());
     ...
     *
     *
     * @param \BigCommerce\Api\Model\BrandPost $brand A &#x60;Brand&#x60; object. (required)
     * @param array $params = []
     * @return \BigCommerce\Api\Model\BrandResponse
     * @throws \BigCommerce\Api\ApiException on non-2xx response
     * @throws \InvalidArgumentException
     */
     ...
     * @throws \BigCommerce\Api\ApiException on non-2xx response
     * @throws \InvalidArgumentException
     * @return array of \BigCommerce\Api\Model\BrandResponse, HTTP status code, HTTP response headers (array of strings)
     */
    public function createBrandWithHttpInfo( $brand, array $params = [])
    {
        ...
        try {
            list($response, $statusCode, $httpHeader) = $this->apiClient->callApi(
                ...
                $httpBody,
                $headerParams,
                '\BigCommerce\Api\Model\BrandResponse',
                '/catalog/brands'
            );
            return [$this->apiClient->getSerializer()->deserialize($response, '\BigCommerce\Api\Model\BrandResponse', $httpHeader), $statusCode, $httpHeader];

         } catch (ApiException $e) {
            switch ($e->getCode()) {
            
                case 200:
                $data = $this->apiClient->getSerializer()->deserialize($e->getResponseBody(), '\BigCommerce\Api\Model\BrandResponse', $e->getResponseHeaders());
                $e->setResponseObject($data);
                break;
     ...
     * @return \BigCommerce\Api\Model\ImageResponse
     * @throws \BigCommerce\Api\ApiException on non-2xx response
     * @throws \InvalidArgumentException
     */
     ...
     * @throws \BigCommerce\Api\ApiException on non-2xx response
     * @throws \InvalidArgumentException
     * @return array of \BigCommerce\Api\Model\ImageResponse, HTTP status code, HTTP response headers (array of strings)
     */
    public function createBrandImageWithHttpInfo($brand_id, array $params = [])
    {
        ...
        try {
            list($response, $statusCode, $httpHeader) = $this->apiClient->callApi(
                ...
                $httpBody,
                $headerParams,
                '\BigCommerce\Api\Model\ImageResponse',
                '/catalog/brands/{brand_id}/image'
            );
            return [$this->apiClient->getSerializer()->deserialize($response, '\BigCommerce\Api\Model\ImageResponse', $httpHeader), $statusCode, $httpHeader];

         } catch (ApiException $e) {
            switch ($e->getCode()) {
            
                case 200:
                $data = $this->apiClient->getSerializer()->deserialize($e->getResponseBody(), '\BigCommerce\Api\Model\ImageResponse', $e->getResponseHeaders());
                $e->setResponseObject($data);
                break;
     ...
     *
     * @param int $brand_id The ID of the &#x60;Brand&#x60; to which the resource belongs. (required)
     * @param \BigCommerce\Api\Model\MetafieldPost $metafield A &#x60;Metafield&#x60; object. (required)
     * @param array $params = []
     * @return \BigCommerce\Api\Model\MetafieldResponse
     * @throws \BigCommerce\Api\ApiException on non-2xx response
     * @throws \InvalidArgumentException
     */
     ...
     * @throws \BigCommerce\Api\ApiException on non-2xx response
     * @throws \InvalidArgumentException
     * @return array of \BigCommerce\Api\Model\MetafieldResponse, HTTP status code, HTTP response headers (array of strings)
     */
    public function createBrandMetafieldWithHttpInfo($brand_id,  $metafield, array $params = [])
    {
        ...
        try {
            list($response, $statusCode, $httpHeader) = $this->apiClient->callApi(
                ...
                $httpBody,
                $headerParams,
                '\BigCommerce\Api\Model\MetafieldResponse',
                '/catalog/brands/{brand_id}/metafields'
            );
            return [$this->apiClient->getSerializer()->deserialize($response, '\BigCommerce\Api\Model\MetafieldResponse', $httpHeader), $statusCode, $httpHeader];

         } catch (ApiException $e) {
            switch ($e->getCode()) {
            
                case 200:
                $data = $this->apiClient->getSerializer()->deserialize($e->getResponseBody(), '\BigCommerce\Api\Model\MetafieldResponse', $e->getResponseHeaders());
                $e->setResponseObject($data);
                break;
     ...
     * @param \BigCommerce\Api\Model\BulkPricingRulePost $bulk_pricing_rule &#x60;BulkPricingRule&#x60; object. (required)
     * @param array $params = []
     *     - page int Specifies the page number in a limited (paginated) list of products. (optional)
     *     - limit int Controls the number of items per page in a limited (paginated) list of products. (optional)
     * @return \BigCommerce\Api\Model\BulkPricingRuleResponse
     * @throws \BigCommerce\Api\ApiException on non-2xx response
     * @throws \InvalidArgumentException
     */
     ...
     * @throws \BigCommerce\Api\ApiException on non-2xx response
     * @throws \InvalidArgumentException
     * @return array of \BigCommerce\Api\Model\BulkPricingRuleResponse, HTTP status code, HTTP response headers (array of strings)
     */
    public function createBulkPricingRuleWithHttpInfo($product_id,  $bulk_pricing_rule, array $params = [])
    {
        ...
        try {
            list($response, $statusCode, $httpHeader) = $this->apiClient->callApi(
                ...
                $httpBody,
                $headerParams,
                '\BigCommerce\Api\Model\BulkPricingRuleResponse',
                '/catalog/products/{product_id}/bulk-pricing-rules'
            );
            return [$this->apiClient->getSerializer()->deserialize($response, '\BigCommerce\Api\Model\BulkPricingRuleResponse', $httpHeader), $statusCode, $httpHeader];

         } catch (ApiException $e) {
            switch ($e->getCode()) {
            
                case 200:
                $data = $this->apiClient->getSerializer()->deserialize($e->getResponseBody(), '\BigCommerce\Api\Model\BulkPricingRuleResponse', $e->getResponseHeaders());
                $e->setResponseObject($data);
                break;
     ...
     *
     *
     * @param \BigCommerce\Api\Model\CategoryPost $category A BigCommerce &#x60;Category&#x60; object. (required)
     * @param array $params = []
     * @return \BigCommerce\Api\Model\CategoryResponse
     * @throws \BigCommerce\Api\ApiException on non-2xx response
     * @throws \InvalidArgumentException
     */
     ...
     * @throws \BigCommerce\Api\ApiException on non-2xx response
     * @throws \InvalidArgumentException
     * @return array of \BigCommerce\Api\Model\CategoryResponse, HTTP status code, HTTP response headers (array of strings)
     */
    public function createCategoryWithHttpInfo( $category, array $params = [])
    {
        ...
        try {
            list($response, $statusCode, $httpHeader) = $this->apiClient->callApi(
                ...
                $httpBody,
                $headerParams,
                '\BigCommerce\Api\Model\CategoryResponse',
                '/catalog/categories'
            );
            return [$this->apiClient->getSerializer()->deserialize($response, '\BigCommerce\Api\Model\CategoryResponse', $httpHeader), $statusCode, $httpHeader];

         } catch (ApiException $e) {
            switch ($e->getCode()) {
            
                case 200:
                $data = $this->apiClient->getSerializer()->deserialize($e->getResponseBody(), '\BigCommerce\Api\Model\CategoryResponse', $e->getResponseHeaders());
                $e->setResponseObject($data);
                break;
     ...
     *
     * @param int $product_id The ID of the &#x60;Product&#x60; to which the resource belongs. (required)
     * @param \BigCommerce\Api\Model\ComplexRulePost $complex_rule &#x60;ComplexRule&#x60; object. (required)
     * @param array $params = []
     * @return \BigCommerce\Api\Model\ComplexRuleResponse
     * @throws \BigCommerce\Api\ApiException on non-2xx response
     * @throws \InvalidArgumentException
     */
     ...
     * @throws \BigCommerce\Api\ApiException on non-2xx response
     * @throws \InvalidArgumentException
     * @return array of \BigCommerce\Api\Model\ComplexRuleResponse, HTTP status code, HTTP response headers (array of strings)
     */
    public function createComplexRuleWithHttpInfo($product_id,  $complex_rule, array $params = [])
    {
        ...
        try {
            list($response, $statusCode, $httpHeader) = $this->apiClient->callApi(
                ...
                $httpBody,
                $headerParams,
                '\BigCommerce\Api\Model\ComplexRuleResponse',
                '/catalog/products/{product_id}/complex-rules'
            );
            return [$this->apiClient->getSerializer()->deserialize($response, '\BigCommerce\Api\Model\ComplexRuleResponse', $httpHeader), $statusCode, $httpHeader];

         } catch (ApiException $e) {
            switch ($e->getCode()) {
            
                case 200:
                $data = $this->apiClient->getSerializer()->deserialize($e->getResponseBody(), '\BigCommerce\Api\Model\ComplexRuleResponse', $e->getResponseHeaders());
                $e->setResponseObject($data);
                break;
     ...
     *
     * @param int $product_id The ID of the &#x60;Product&#x60; to which the resource belongs. (required)
     * @param \BigCommerce\Api\Model\ConfigurableFieldPost $configurable_field &#x60;ConfigurableField&#x60; object. (required)
     * @param array $params = []
     * @return \BigCommerce\Api\Model\ConfigurableFieldResponse
     * @throws \BigCommerce\Api\ApiException on non-2xx response
     * @throws \InvalidArgumentException
     */
     ...
     * @throws \BigCommerce\Api\ApiException on non-2xx response
     * @throws \InvalidArgumentException
     * @return array of \BigCommerce\Api\Model\ConfigurableFieldResponse, HTTP status code, HTTP response headers (array of strings)
     */
    public function createConfigurableFieldWithHttpInfo($product_id,  $configurable_field, array $params = [])
    {
        ...
        try {
            list($response, $statusCode, $httpHeader) = $this->apiClient->callApi(
                ...
                $httpBody,
                $headerParams,
                '\BigCommerce\Api\Model\ConfigurableFieldResponse',
                '/catalog/products/{product_id}/configurable-fields'
            );
            return [$this->apiClient->getSerializer()->deserialize($response, '\BigCommerce\Api\Model\ConfigurableFieldResponse', $httpHeader), $statusCode, $httpHeader];

         } catch (ApiException $e) {
            switch ($e->getCode()) {
            
                case 200:
                $data = $this->apiClient->getSerializer()->deserialize($e->getResponseBody(), '\BigCommerce\Api\Model\ConfigurableFieldResponse', $e->getResponseHeaders());
                $e->setResponseObject($data);
                break;
     ...
     *
     * @param int $product_id The ID of the &#x60;Product&#x60; to which the resource belongs. (required)
     * @param \BigCommerce\Api\Model\CustomFieldPost $custom_field &#x60;CustomField&#x60; object. (required)
     * @param array $params = []
     * @return \BigCommerce\Api\Model\CustomFieldResponse
     * @throws \BigCommerce\Api\ApiException on non-2xx response
     * @throws \InvalidArgumentException
     */
     ...
     * @throws \BigCommerce\Api\ApiException on non-2xx response
     * @throws \InvalidArgumentException
     * @return array of \BigCommerce\Api\Model\CustomFieldResponse, HTTP status code, HTTP response headers (array of strings)
     */
    public function createCustomFieldWithHttpInfo($product_id,  $custom_field, array $params = [])
    {
        ...
        try {
            list($response, $statusCode, $httpHeader) = $this->apiClient->callApi(
                ...
                $httpBody,
                $headerParams,
                '\BigCommerce\Api\Model\CustomFieldResponse',
                '/catalog/products/{product_id}/custom-fields'
            );
            return [$this->apiClient->getSerializer()->deserialize($response, '\BigCommerce\Api\Model\CustomFieldResponse', $httpHeader), $statusCode, $httpHeader];

         } catch (ApiException $e) {
            switch ($e->getCode()) {
            
                case 200:
                $data = $this->apiClient->getSerializer()->deserialize($e->getResponseBody(), '\BigCommerce\Api\Model\CustomFieldResponse', $e->getResponseHeaders());
                $e->setResponseObject($data);
                break;
     ...
     *
     * @param int $product_id The ID of the &#x60;Product&#x60; to which the resource belongs. (required)
     * @param \BigCommerce\Api\Model\ModifierPost $modifier A &#x60;Modifier&#x60; object. (required)
     * @param array $params = []
     * @return \BigCommerce\Api\Model\ModifierResponse
     * @throws \BigCommerce\Api\ApiException on non-2xx response
     * @throws \InvalidArgumentException
     */
     ...
     * @throws \BigCommerce\Api\ApiException on non-2xx response
     * @throws \InvalidArgumentException
     * @return array of \BigCommerce\Api\Model\ModifierResponse, HTTP status code, HTTP response headers (array of strings)
     */
    public function createModifierWithHttpInfo($product_id,  $modifier, array $params = [])
    {
        ...
        try {
            list($response, $statusCode, $httpHeader) = $this->apiClient->callApi(
                ...
                $httpBody,
                $headerParams,
                '\BigCommerce\Api\Model\ModifierResponse',
                '/catalog/products/{product_id}/modifiers'
            );
            return [$this->apiClient->getSerializer()->deserialize($response, '\BigCommerce\Api\Model\ModifierResponse', $httpHeader), $statusCode, $httpHeader];

         } catch (ApiException $e) {
            switch ($e->getCode()) {
            
                case 200:
                $data = $this->apiClient->getSerializer()->deserialize($e->getResponseBody(), '\BigCommerce\Api\Model\ModifierResponse', $e->getResponseHeaders());
                $e->setResponseObject($data);
                break;
     ...
     * @param int $product_id The ID of the &#x60;Product&#x60; to which the resource belongs. (required)
     * @param int $modifier_id The ID of the &#x60;Modifier&#x60;. (required)
     * @param \BigCommerce\Api\Model\ModifierValuePost $modifier_value A &#x60;ModifierValue&#x60; object. (required)
     * @param array $params = []
     * @return \BigCommerce\Api\Model\ModifierValueResponse
     * @throws \BigCommerce\Api\ApiException on non-2xx response
     * @throws \InvalidArgumentException
     */
     ...
     * @throws \BigCommerce\Api\ApiException on non-2xx response
     * @throws \InvalidArgumentException
     * @return array of \BigCommerce\Api\Model\ModifierValueResponse, HTTP status code, HTTP response headers (array of strings)
     */
    public function createModifierValueWithHttpInfo($product_id, $modifier_id,  $modifier_value, array $params = [])
    {
        ...
        try {
            list($response, $statusCode, $httpHeader) = $this->apiClient->callApi(
                ...
                $httpBody,
                $headerParams,
                '\BigCommerce\Api\Model\ModifierValueResponse',
                '/catalog/products/{product_id}/modifiers/{modifier_id}/values'
            );
            return [$this->apiClient->getSerializer()->deserialize($response, '\BigCommerce\Api\Model\ModifierValueResponse', $httpHeader), $statusCode, $httpHeader];

         } catch (ApiException $e) {
            switch ($e->getCode()) {
            
                case 200:
                $data = $this->apiClient->getSerializer()->deserialize($e->getResponseBody(), '\BigCommerce\Api\Model\ModifierValueResponse', $e->getResponseHeaders());
                $e->setResponseObject($data);
                break;
     ...
     *
     * @param int $product_id The ID of the &#x60;Product&#x60; to which the resource belongs. (required)
     * @param \BigCommerce\Api\Model\OptionPost $option An &#x60;Option&#x60; object. (required)
     * @param array $params = []
     * @return \BigCommerce\Api\Model\OptionResponse
     * @throws \BigCommerce\Api\ApiException on non-2xx response
     * @throws \InvalidArgumentException
     */
     ...
     * @throws \BigCommerce\Api\ApiException on non-2xx response
     * @throws \InvalidArgumentException
     * @return array of \BigCommerce\Api\Model\OptionResponse, HTTP status code, HTTP response headers (array of strings)
     */
    public function createOptionWithHttpInfo($product_id,  $option, array $params = [])
    {
        ...
        try {
            list($response, $statusCode, $httpHeader) = $this->apiClient->callApi(
                ...
                $httpBody,
                $headerParams,
                '\BigCommerce\Api\Model\OptionResponse',
                '/catalog/products/{product_id}/options'
            );
            return [$this->apiClient->getSerializer()->deserialize($response, '\BigCommerce\Api\Model\OptionResponse', $httpHeader), $statusCode, $httpHeader];

         } catch (ApiException $e) {
            switch ($e->getCode()) {
            
                case 200:
                $data = $this->apiClient->getSerializer()->deserialize($e->getResponseBody(), '\BigCommerce\Api\Model\OptionResponse', $e->getResponseHeaders());
                $e->setResponseObject($data);
                break;
     ...
     * @param \BigCommerce\Api\Model\OptionValuePost $option_value A &#x60;OptionValue&#x60; object. (required)
     * @param array $params = []
     * @return \BigCommerce\Api\Model\OptionValueResponse
     * @throws \BigCommerce\Api\ApiException on non-2xx response
     * @throws \InvalidArgumentException
     */
     ...
     * @throws \BigCommerce\Api\ApiException on non-2xx response
     * @throws \InvalidArgumentException
     * @return array of \BigCommerce\Api\Model\OptionValueResponse, HTTP status code, HTTP response headers (array of strings)
     */
    public function createOptionValueWithHttpInfo($product_id, $option_id,  $option_value, array $params = [])
    {
        ...
        try {
            list($response, $statusCode, $httpHeader) = $this->apiClient->callApi(
                ...
                $httpBody,
                $headerParams,
                '\BigCommerce\Api\Model\OptionValueResponse',
                '/catalog/products/{product_id}/options/{option_id}/values'
            );
            return [$this->apiClient->getSerializer()->deserialize($response, '\BigCommerce\Api\Model\OptionValueResponse', $httpHeader), $statusCode, $httpHeader];

         } catch (ApiException $e) {
            switch ($e->getCode()) {
            
                case 200:
                $data = $this->apiClient->getSerializer()->deserialize($e->getResponseBody(), '\BigCommerce\Api\Model\OptionValueResponse', $e->getResponseHeaders());
                $e->setResponseObject($data);
                break;
     ...
     *
     *
     * @param \BigCommerce\Api\Model\ProductPost $product A BigCommerce &#x60;Product&#x60; object. (required)
     * @param array $params = []
     * @return \BigCommerce\Api\Model\ProductResponse
     * @throws \BigCommerce\Api\ApiException on non-2xx response
     * @throws \InvalidArgumentException
     */
     ...
     * @throws \BigCommerce\Api\ApiException on non-2xx response
     * @throws \InvalidArgumentException
     * @return array of \BigCommerce\Api\Model\ProductResponse, HTTP status code, HTTP response headers (array of strings)
     */
    public function createProductWithHttpInfo( $product, array $params = [])
    {
        ...
        try {
            list($response, $statusCode, $httpHeader) = $this->apiClient->callApi(
                ...
                $httpBody,
                $headerParams,
                '\BigCommerce\Api\Model\ProductResponse',
                '/catalog/products'
            );
            return [$this->apiClient->getSerializer()->deserialize($response, '\BigCommerce\Api\Model\ProductResponse', $httpHeader), $statusCode, $httpHeader];

         } catch (ApiException $e) {
            switch ($e->getCode()) {
            
                case 200:
                $data = $this->apiClient->getSerializer()->deserialize($e->getResponseBody(), '\BigCommerce\Api\Model\ProductResponse', $e->getResponseHeaders());
                $e->setResponseObject($data);
                break;
     ...
     *
     * @param int $product_id The ID of the &#x60;Product&#x60; to which the resource belongs. (required)
     * @param \BigCommerce\Api\Model\ProductImagePost $product_image A BigCommerce &#x60;ProductImage&#x60; object. (required)
     * @param array $params = []
     * @return \BigCommerce\Api\Model\ProductImageResponse
     * @throws \BigCommerce\Api\ApiException on non-2xx response
     * @throws \InvalidArgumentException
     */
     ...
     * @throws \BigCommerce\Api\ApiException on non-2xx response
     * @throws \InvalidArgumentException
     * @return array of \BigCommerce\Api\Model\ProductImageResponse, HTTP status code, HTTP response headers (array of strings)
     */
    public function createProductImageWithHttpInfo($product_id,  $product_image, array $params = [])
    {
        ...
        try {
            list($response, $statusCode, $httpHeader) = $this->apiClient->callApi(
                ...
                $httpBody,
                $headerParams,
                '\BigCommerce\Api\Model\ProductImageResponse',
                '/catalog/products/{product_id}/images'
            );
            return [$this->apiClient->getSerializer()->deserialize($response, '\BigCommerce\Api\Model\ProductImageResponse', $httpHeader), $statusCode, $httpHeader];

         } catch (ApiException $e) {
            switch ($e->getCode()) {
            
                case 200:
                $data = $this->apiClient->getSerializer()->deserialize($e->getResponseBody(), '\BigCommerce\Api\Model\ProductImageResponse', $e->getResponseHeaders());
                $e->setResponseObject($data);
                break;
     ...
     *
     * @param int $product_id The ID of the &#x60;Product&#x60; to which the resource belongs. (required)
     * @param \BigCommerce\Api\Model\ProductReviewPost $product_review A BigCommerce &#x60;ProductReview&#x60; object. (required)
     * @param array $params = []
     * @return \BigCommerce\Api\Model\ProductReviewResponse
     * @throws \BigCommerce\Api\ApiException on non-2xx response
     * @throws \InvalidArgumentException
     */
     ...
     * @throws \BigCommerce\Api\ApiException on non-2xx response
     * @throws \InvalidArgumentException
     * @return array of \BigCommerce\Api\Model\ProductReviewResponse, HTTP status code, HTTP response headers (array of strings)
     */
    public function createProductReviewWithHttpInfo($product_id,  $product_review, array $params = [])
    {
        ...
        try {
            list($response, $statusCode, $httpHeader) = $this->apiClient->callApi(
                ...
                $httpBody,
                $headerParams,
                '\BigCommerce\Api\Model\ProductReviewResponse',
                '/catalog/products/{product_id}/reviews'
            );
            return [$this->apiClient->getSerializer()->deserialize($response, '\BigCommerce\Api\Model\ProductReviewResponse', $httpHeader), $statusCode, $httpHeader];

         } catch (ApiException $e) {
            switch ($e->getCode()) {
            
                case 200:
                $data = $this->apiClient->getSerializer()->deserialize($e->getResponseBody(), '\BigCommerce\Api\Model\ProductReviewResponse', $e->getResponseHeaders());
                $e->setResponseObject($data);
                break;
     ...
     *
     * @param int $product_id The ID of the &#x60;Product&#x60; to which the resource belongs. (required)
     * @param \BigCommerce\Api\Model\ProductVideoPost $product_video A BigCommerce &#x60;ProductVideo&#x60; object. (required)
     * @param array $params = []
     * @return \BigCommerce\Api\Model\ProductVideoResponse
     * @throws \BigCommerce\Api\ApiException on non-2xx response
     * @throws \InvalidArgumentException
     */
     ...
     * @throws \BigCommerce\Api\ApiException on non-2xx response
     * @throws \InvalidArgumentException
     * @return array of \BigCommerce\Api\Model\ProductVideoResponse, HTTP status code, HTTP response headers (array of strings)
     */
    public function createProductVideoWithHttpInfo($product_id,  $product_video, array $params = [])
    {
        ...
        try {
            list($response, $statusCode, $httpHeader) = $this->apiClient->callApi(
                ...
                $httpBody,
                $headerParams,
                '\BigCommerce\Api\Model\ProductVideoResponse',
                '/catalog/products/{product_id}/videos'
            );
            return [$this->apiClient->getSerializer()->deserialize($response, '\BigCommerce\Api\Model\ProductVideoResponse', $httpHeader), $statusCode, $httpHeader];

         } catch (ApiException $e) {
            switch ($e->getCode()) {
            
                case 200:
                $data = $this->apiClient->getSerializer()->deserialize($e->getResponseBody(), '\BigCommerce\Api\Model\ProductVideoResponse', $e->getResponseHeaders());
                $e->setResponseObject($data);
                break;
     ...
     *
     * @param int $product_id The ID of the &#x60;Product&#x60; to which the resource belongs. (required)
     * @param \BigCommerce\Api\Model\VariantPost $variant &#x60;Variant&#x60; object. (required)
     * @param array $params = []
     * @return \BigCommerce\Api\Model\VariantResponse
     * @throws \BigCommerce\Api\ApiException on non-2xx response
     * @throws \InvalidArgumentException
     */
     ...
     * @throws \BigCommerce\Api\ApiException on non-2xx response
     * @throws \InvalidArgumentException
     * @return array of \BigCommerce\Api\Model\VariantResponse, HTTP status code, HTTP response headers (array of strings)
     */
    public function createVariantWithHttpInfo($product_id,  $variant, array $params = [])
    {
        ...
        try {
            list($response, $statusCode, $httpHeader) = $this->apiClient->callApi(
                ...
                $httpBody,
                $headerParams,
                '\BigCommerce\Api\Model\VariantResponse',
                '/catalog/products/{product_id}/variants'
            );
            return [$this->apiClient->getSerializer()->deserialize($response, '\BigCommerce\Api\Model\VariantResponse', $httpHeader), $statusCode, $httpHeader];

         } catch (ApiException $e) {
            switch ($e->getCode()) {
            
                case 200:
                $data = $this->apiClient->getSerializer()->deserialize($e->getResponseBody(), '\BigCommerce\Api\Model\VariantResponse', $e->getResponseHeaders());
                $e->setResponseObject($data);
                break;
     ...
     *     - include_fields string Fields to include, in a comma-separated list. The ID and the specified fields will be returned. (optional)
     *     - exclude_fields string Fields to exclude, in a comma-separated list. The specified fields will be excluded from a response. The ID cannot be excluded. (optional)
     * @return \BigCommerce\Api\Model\MetaFieldCollectionResponse
     * @throws \BigCommerce\Api\ApiException on non-2xx response
     * @throws \InvalidArgumentException
     */
     ...
     * @throws \BigCommerce\Api\ApiException on non-2xx response
     * @throws \InvalidArgumentException
     * @return array of \BigCommerce\Api\Model\MetaFieldCollectionResponse, HTTP status code, HTTP response headers (array of strings)
     */
    public function getBrandMetafieldsByBrandIdWithHttpInfo($brand_id, array $params = [])
    {
        ...
        try {
            list($response, $statusCode, $httpHeader) = $this->apiClient->callApi(
                ...
                $httpBody,
                $headerParams,
                '\BigCommerce\Api\Model\MetaFieldCollectionResponse',
                '/catalog/brands/{brand_id}/metafields'
            );
            return [$this->apiClient->getSerializer()->deserialize($response, '\BigCommerce\Api\Model\MetaFieldCollectionResponse', $httpHeader), $statusCode, $httpHeader];

         } catch (ApiException $e) {
            switch ($e->getCode()) {
            
                case 200:
                $data = $this->apiClient->getSerializer()->deserialize($e->getResponseBody(), '\BigCommerce\Api\Model\MetaFieldCollectionResponse', $e->getResponseHeaders());
                $e->setResponseObject($data);
                break;
     ...
     *     - include_fields string Fields to include, in a comma-separated list. The ID and the specified fields will be returned. (optional)
     *     - exclude_fields string Fields to exclude, in a comma-separated list. The specified fields will be excluded from a response. The ID cannot be excluded. (optional)
     * @return \BigCommerce\Api\Model\BrandCollectionResponse
     * @throws \BigCommerce\Api\ApiException on non-2xx response
     * @throws \InvalidArgumentException
     */
     ...
     * @throws \BigCommerce\Api\ApiException on non-2xx response
     * @throws \InvalidArgumentException
     * @return array of \BigCommerce\Api\Model\BrandCollectionResponse, HTTP status code, HTTP response headers (array of strings)
     */
    public function getBrandsWithHttpInfo(array $params = [])
    {
        ...
        try {
            list($response, $statusCode, $httpHeader) = $this->apiClient->callApi(
                ...
                $httpBody,
                $headerParams,
                '\BigCommerce\Api\Model\BrandCollectionResponse',
                '/catalog/brands'
            );
            return [$this->apiClient->getSerializer()->deserialize($response, '\BigCommerce\Api\Model\BrandCollectionResponse', $httpHeader), $statusCode, $httpHeader];

         } catch (ApiException $e) {
            switch ($e->getCode()) {
            
                case 200:
                $data = $this->apiClient->getSerializer()->deserialize($e->getResponseBody(), '\BigCommerce\Api\Model\BrandCollectionResponse', $e->getResponseHeaders());
                $e->setResponseObject($data);
                break;
     ...
     *     - include_fields string Fields to include, in a comma-separated list. The ID and the specified fields will be returned. (optional)
     *     - exclude_fields string Fields to exclude, in a comma-separated list. The specified fields will be excluded from a response. The ID cannot be excluded. (optional)
     * @return \BigCommerce\Api\Model\BulkPricingRuleCollectionResponse
     * @throws \BigCommerce\Api\ApiException on non-2xx response
     * @throws \InvalidArgumentException
     */
     ...
     * @throws \BigCommerce\Api\ApiException on non-2xx response
     * @throws \InvalidArgumentException
     * @return array of \BigCommerce\Api\Model\BulkPricingRuleCollectionResponse, HTTP status code, HTTP response headers (array of strings)
     */
    public function getBulkPricingRulesWithHttpInfo($product_id, array $params = [])
    {
        ...
        try {
            list($response, $statusCode, $httpHeader) = $this->apiClient->callApi(
                ...
                $httpBody,
                $headerParams,
                '\BigCommerce\Api\Model\BulkPricingRuleCollectionResponse',
                '/catalog/products/{product_id}/bulk-pricing-rules'
            );
            return [$this->apiClient->getSerializer()->deserialize($response, '\BigCommerce\Api\Model\BulkPricingRuleCollectionResponse', $httpHeader), $statusCode, $httpHeader];

         } catch (ApiException $e) {
            switch ($e->getCode()) {
            
                case 200:
                $data = $this->apiClient->getSerializer()->deserialize($e->getResponseBody(), '\BigCommerce\Api\Model\BulkPricingRuleCollectionResponse', $e->getResponseHeaders());
                $e->setResponseObject($data);
                break;
     ...
     *     - include_fields string Fields to include, in a comma-separated list. The ID and the specified fields will be returned. (optional)
     *     - exclude_fields string Fields to exclude, in a comma-separated list. The specified fields will be excluded from a response. The ID cannot be excluded. (optional)
     * @return \BigCommerce\Api\Model\CategoryCollectionResponse
     * @throws \BigCommerce\Api\ApiException on non-2xx response
     * @throws \InvalidArgumentException
     */
     ...
     * @throws \BigCommerce\Api\ApiException on non-2xx response
     * @throws \InvalidArgumentException
     * @return array of \BigCommerce\Api\Model\CategoryCollectionResponse, HTTP status code, HTTP response headers (array of strings)
     */
    public function getCategoriesWithHttpInfo(array $params = [])
    {
        ...
        try {
            list($response, $statusCode, $httpHeader) = $this->apiClient->callApi(
                ...
                $httpBody,
                $headerParams,
                '\BigCommerce\Api\Model\CategoryCollectionResponse',
                '/catalog/categories'
            );
            return [$this->apiClient->getSerializer()->deserialize($response, '\BigCommerce\Api\Model\CategoryCollectionResponse', $httpHeader), $statusCode, $httpHeader];

         } catch (ApiException $e) {
            switch ($e->getCode()) {
            
                case 200:
                $data = $this->apiClient->getSerializer()->deserialize($e->getResponseBody(), '\BigCommerce\Api\Model\CategoryCollectionResponse', $e->getResponseHeaders());
                $e->setResponseObject($data);
                break;
     ...
     *
     * @param array $params = []
     * @return \BigCommerce\Api\Model\CategoryTreeCollectionResponse
     * @throws \BigCommerce\Api\ApiException on non-2xx response
     * @throws \InvalidArgumentException
     */
     ...
     * @throws \BigCommerce\Api\ApiException on non-2xx response
     * @throws \InvalidArgumentException
     * @return array of \BigCommerce\Api\Model\CategoryTreeCollectionResponse, HTTP status code, HTTP response headers (array of strings)
     */
    public function getCategoryTreeWithHttpInfo(array $params = [])
    {
        ...
        try {
            list($response, $statusCode, $httpHeader) = $this->apiClient->callApi(
                ...
                $httpBody,
                $headerParams,
                '\BigCommerce\Api\Model\CategoryTreeCollectionResponse',
                '/catalog/categories/tree'
            );
            return [$this->apiClient->getSerializer()->deserialize($response, '\BigCommerce\Api\Model\CategoryTreeCollectionResponse', $httpHeader), $statusCode, $httpHeader];

         } catch (ApiException $e) {
            switch ($e->getCode()) {
            
                case 200:
                $data = $this->apiClient->getSerializer()->deserialize($e->getResponseBody(), '\BigCommerce\Api\Model\CategoryTreeCollectionResponse', $e->getResponseHeaders());
                $e->setResponseObject($data);
                break;
     ...
     *     - include_fields string Fields to include, in a comma-separated list. The ID and the specified fields will be returned. (optional)
     *     - exclude_fields string Fields to exclude, in a comma-separated list. The specified fields will be excluded from a response. The ID cannot be excluded. (optional)
     * @return \BigCommerce\Api\Model\ComplexRuleCollectionResponse
     * @throws \BigCommerce\Api\ApiException on non-2xx response
     * @throws \InvalidArgumentException
     */
     ...
     * @throws \BigCommerce\Api\ApiException on non-2xx response
     * @throws \InvalidArgumentException
     * @return array of \BigCommerce\Api\Model\ComplexRuleCollectionResponse, HTTP status code, HTTP response headers (array of strings)
     */
    public function getComplexRulesWithHttpInfo($product_id, array $params = [])
    {
        ...
        try {
            list($response, $statusCode, $httpHeader) = $this->apiClient->callApi(
                ...
                $httpBody,
                $headerParams,
                '\BigCommerce\Api\Model\ComplexRuleCollectionResponse',
                '/catalog/products/{product_id}/complex-rules'
            );
            return [$this->apiClient->getSerializer()->deserialize($response, '\BigCommerce\Api\Model\ComplexRuleCollectionResponse', $httpHeader), $statusCode, $httpHeader];

         } catch (ApiException $e) {
            switch ($e->getCode()) {
            
                case 200:
                $data = $this->apiClient->getSerializer()->deserialize($e->getResponseBody(), '\BigCommerce\Api\Model\ComplexRuleCollectionResponse', $e->getResponseHeaders());
                $e->setResponseObject($data);
                break;
     ...
     *     - page int Specifies the page number in a limited (paginated) list of products. (optional)
     *     - limit int Controls the number of items per page in a limited (paginated) list of products. (optional)
     * @return \BigCommerce\Api\Model\ConfigurableFieldCollectionResponse
     * @throws \BigCommerce\Api\ApiException on non-2xx response
     * @throws \InvalidArgumentException
     */
     ...
     * @throws \BigCommerce\Api\ApiException on non-2xx response
     * @throws \InvalidArgumentException
     * @return array of \BigCommerce\Api\Model\ConfigurableFieldCollectionResponse, HTTP status code, HTTP response headers (array of strings)
     */
    public function getConfigurableFieldsWithHttpInfo($product_id, array $params = [])
    {
        ...
        try {
            list($response, $statusCode, $httpHeader) = $this->apiClient->callApi(
                ...
                $httpBody,
                $headerParams,
                '\BigCommerce\Api\Model\ConfigurableFieldCollectionResponse',
                '/catalog/products/{product_id}/configurable-fields'
            );
            return [$this->apiClient->getSerializer()->deserialize($response, '\BigCommerce\Api\Model\ConfigurableFieldCollectionResponse', $httpHeader), $statusCode, $httpHeader];

         } catch (ApiException $e) {
            switch ($e->getCode()) {
            
                case 200:
                $data = $this->apiClient->getSerializer()->deserialize($e->getResponseBody(), '\BigCommerce\Api\Model\ConfigurableFieldCollectionResponse', $e->getResponseHeaders());
                $e->setResponseObject($data);
                break;
     ...
     *     - page int Specifies the page number in a limited (paginated) list of products. (optional)
     *     - limit int Controls the number of items per page in a limited (paginated) list of products. (optional)
     * @return \BigCommerce\Api\Model\CustomFieldCollectionResponse
     * @throws \BigCommerce\Api\ApiException on non-2xx response
     * @throws \InvalidArgumentException
     */
     ...
     * @throws \BigCommerce\Api\ApiException on non-2xx response
     * @throws \InvalidArgumentException
     * @return array of \BigCommerce\Api\Model\CustomFieldCollectionResponse, HTTP status code, HTTP response headers (array of strings)
     */
    public function getCustomFieldsWithHttpInfo($product_id, array $params = [])
    {
        ...
        try {
            list($response, $statusCode, $httpHeader) = $this->apiClient->callApi(
                ...
                $httpBody,
                $headerParams,
                '\BigCommerce\Api\Model\CustomFieldCollectionResponse',
                '/catalog/products/{product_id}/custom-fields'
            );
            return [$this->apiClient->getSerializer()->deserialize($response, '\BigCommerce\Api\Model\CustomFieldCollectionResponse', $httpHeader), $statusCode, $httpHeader];

         } catch (ApiException $e) {
            switch ($e->getCode()) {
            
                case 200:
                $data = $this->apiClient->getSerializer()->deserialize($e->getResponseBody(), '\BigCommerce\Api\Model\CustomFieldCollectionResponse', $e->getResponseHeaders());
                $e->setResponseObject($data);
                break;
     ...
     *     - include_fields string Fields to include, in a comma-separated list. The ID and the specified fields will be returned. (optional)
     *     - exclude_fields string Fields to exclude, in a comma-separated list. The specified fields will be excluded from a response. The ID cannot be excluded. (optional)
     * @return \BigCommerce\Api\Model\ModifierValueCollectionResponse
     * @throws \BigCommerce\Api\ApiException on non-2xx response
     * @throws \InvalidArgumentException
     */
     ...
     * @throws \BigCommerce\Api\ApiException on non-2xx response
     * @throws \InvalidArgumentException
     * @return array of \BigCommerce\Api\Model\ModifierValueCollectionResponse, HTTP status code, HTTP response headers (array of strings)
     */
    public function getModifierValuesWithHttpInfo($product_id, $modifier_id, array $params = [])
    {
        ...
        try {
            list($response, $statusCode, $httpHeader) = $this->apiClient->callApi(
                ...
                $httpBody,
                $headerParams,
                '\BigCommerce\Api\Model\ModifierValueCollectionResponse',
                '/catalog/products/{product_id}/modifiers/{modifier_id}/values'
            );
            return [$this->apiClient->getSerializer()->deserialize($response, '\BigCommerce\Api\Model\ModifierValueCollectionResponse', $httpHeader), $statusCode, $httpHeader];

         } catch (ApiException $e) {
            switch ($e->getCode()) {
            
                case 200:
                $data = $this->apiClient->getSerializer()->deserialize($e->getResponseBody(), '\BigCommerce\Api\Model\ModifierValueCollectionResponse', $e->getResponseHeaders());
                $e->setResponseObject($data);
                break;
     ...
     *     - include_fields string Fields to include, in a comma-separated list. The ID and the specified fields will be returned. (optional)
     *     - exclude_fields string Fields to exclude, in a comma-separated list. The specified fields will be excluded from a response. The ID cannot be excluded. (optional)
     * @return \BigCommerce\Api\Model\ModifierCollectionResponse
     * @throws \BigCommerce\Api\ApiException on non-2xx response
     * @throws \InvalidArgumentException
     */
     ...
     * @throws \BigCommerce\Api\ApiException on non-2xx response
     * @throws \InvalidArgumentException
     * @return array of \BigCommerce\Api\Model\ModifierCollectionResponse, HTTP status code, HTTP response headers (array of strings)
     */
    public function getModifiersWithHttpInfo($product_id, array $params = [])
    {
        ...
        try {
            list($response, $statusCode, $httpHeader) = $this->apiClient->callApi(
                ...
                $httpBody,
                $headerParams,
                '\BigCommerce\Api\Model\ModifierCollectionResponse',
                '/catalog/products/{product_id}/modifiers'
            );
            return [$this->apiClient->getSerializer()->deserialize($response, '\BigCommerce\Api\Model\ModifierCollectionResponse', $httpHeader), $statusCode, $httpHeader];

         } catch (ApiException $e) {
            switch ($e->getCode()) {
            
                case 200:
                $data = $this->apiClient->getSerializer()->deserialize($e->getResponseBody(), '\BigCommerce\Api\Model\ModifierCollectionResponse', $e->getResponseHeaders());
                $e->setResponseObject($data);
                break;
     ...
     *     - include_fields string Fields to include, in a comma-separated list. The ID and the specified fields will be returned. (optional)
     *     - exclude_fields string Fields to exclude, in a comma-separated list. The specified fields will be excluded from a response. The ID cannot be excluded. (optional)
     * @return \BigCommerce\Api\Model\OptionValueCollectionResponse
     * @throws \BigCommerce\Api\ApiException on non-2xx response
     * @throws \InvalidArgumentException
     */
     ...
     * @throws \BigCommerce\Api\ApiException on non-2xx response
     * @throws \InvalidArgumentException
     * @return array of \BigCommerce\Api\Model\OptionValueCollectionResponse, HTTP status code, HTTP response headers (array of strings)
     */
    public function getOptionValuesWithHttpInfo($product_id, $option_id, array $params = [])
    {
        ...
        try {
            list($response, $statusCode, $httpHeader) = $this->apiClient->callApi(
                ...
                $httpBody,
                $headerParams,
                '\BigCommerce\Api\Model\OptionValueCollectionResponse',
                '/catalog/products/{product_id}/options/{option_id}/values'
            );
            return [$this->apiClient->getSerializer()->deserialize($response, '\BigCommerce\Api\Model\OptionValueCollectionResponse', $httpHeader), $statusCode, $httpHeader];

         } catch (ApiException $e) {
            switch ($e->getCode()) {
            
                case 200:
                $data = $this->apiClient->getSerializer()->deserialize($e->getResponseBody(), '\BigCommerce\Api\Model\OptionValueCollectionResponse', $e->getResponseHeaders());
                $e->setResponseObject($data);
                break;
     ...
     *     - include_fields string Fields to include, in a comma-separated list. The ID and the specified fields will be returned. (optional)
     *     - exclude_fields string Fields to exclude, in a comma-separated list. The specified fields will be excluded from a response. The ID cannot be excluded. (optional)
     * @return \BigCommerce\Api\Model\OptionCollectionResponse
     * @throws \BigCommerce\Api\ApiException on non-2xx response
     * @throws \InvalidArgumentException
     */
     ...
     * @throws \BigCommerce\Api\ApiException on non-2xx response
     * @throws \InvalidArgumentException
     * @return array of \BigCommerce\Api\Model\OptionCollectionResponse, HTTP status code, HTTP response headers (array of strings)
     */
    public function getOptionsWithHttpInfo($product_id, array $params = [])
    {
        ...
        try {
            list($response, $statusCode, $httpHeader) = $this->apiClient->callApi(
                ...
                $httpBody,
                $headerParams,
                '\BigCommerce\Api\Model\OptionCollectionResponse',
                '/catalog/products/{product_id}/options'
            );
            return [$this->apiClient->getSerializer()->deserialize($response, '\BigCommerce\Api\Model\OptionCollectionResponse', $httpHeader), $statusCode, $httpHeader];

         } catch (ApiException $e) {
            switch ($e->getCode()) {
            
                case 200:
                $data = $this->apiClient->getSerializer()->deserialize($e->getResponseBody(), '\BigCommerce\Api\Model\OptionCollectionResponse', $e->getResponseHeaders());
                $e->setResponseObject($data);
                break;
     ...
     *     - include_fields string Fields to include, in a comma-separated list. The ID and the specified fields will be returned. (optional)
     *     - exclude_fields string Fields to exclude, in a comma-separated list. The specified fields will be excluded from a response. The ID cannot be excluded. (optional)
     * @return \BigCommerce\Api\Model\ProductImageCollectionResponse
     * @throws \BigCommerce\Api\ApiException on non-2xx response
     * @throws \InvalidArgumentException
     */
     ...
     * @throws \BigCommerce\Api\ApiException on non-2xx response
     * @throws \InvalidArgumentException
     * @return array of \BigCommerce\Api\Model\ProductImageCollectionResponse, HTTP status code, HTTP response headers (array of strings)
     */
    public function getProductImagesWithHttpInfo($product_id, array $params = [])
    {
        ...
        try {
            list($response, $statusCode, $httpHeader) = $this->apiClient->callApi(
                ...
                $httpBody,
                $headerParams,
                '\BigCommerce\Api\Model\ProductImageCollectionResponse',
                '/catalog/products/{product_id}/images'
            );
            return [$this->apiClient->getSerializer()->deserialize($response, '\BigCommerce\Api\Model\ProductImageCollectionResponse', $httpHeader), $statusCode, $httpHeader];

         } catch (ApiException $e) {
            switch ($e->getCode()) {
            
                case 200:
                $data = $this->apiClient->getSerializer()->deserialize($e->getResponseBody(), '\BigCommerce\Api\Model\ProductImageCollectionResponse', $e->getResponseHeaders());
                $e->setResponseObject($data);
                break;
     ...
     *     - page int Specifies the page number in a limited (paginated) list of products. (optional)
     *     - limit int Controls the number of items per page in a limited (paginated) list of products. (optional)
     * @return \BigCommerce\Api\Model\ProductReviewCollectionResponse
     * @throws \BigCommerce\Api\ApiException on non-2xx response
     * @throws \InvalidArgumentException
     */
     ...
     * @throws \BigCommerce\Api\ApiException on non-2xx response
     * @throws \InvalidArgumentException
     * @return array of \BigCommerce\Api\Model\ProductReviewCollectionResponse, HTTP status code, HTTP response headers (array of strings)
     */
    public function getProductReviewsWithHttpInfo($product_id, array $params = [])
    {
        ...
        try {
            list($response, $statusCode, $httpHeader) = $this->apiClient->callApi(
                ...
                $httpBody,
                $headerParams,
                '\BigCommerce\Api\Model\ProductReviewCollectionResponse',
                '/catalog/products/{product_id}/reviews'
            );
            return [$this->apiClient->getSerializer()->deserialize($response, '\BigCommerce\Api\Model\ProductReviewCollectionResponse', $httpHeader), $statusCode, $httpHeader];

         } catch (ApiException $e) {
            switch ($e->getCode()) {
            
                case 200:
                $data = $this->apiClient->getSerializer()->deserialize($e->getResponseBody(), '\BigCommerce\Api\Model\ProductReviewCollectionResponse', $e->getResponseHeaders());
                $e->setResponseObject($data);
                break;
     ...
     *     - include_fields string Fields to include, in a comma-separated list. The ID and the specified fields will be returned. (optional)
     *     - exclude_fields string Fields to exclude, in a comma-separated list. The specified fields will be excluded from a response. The ID cannot be excluded. (optional)
     * @return \BigCommerce\Api\Model\ProductVideoCollectionResponse
     * @throws \BigCommerce\Api\ApiException on non-2xx response
     * @throws \InvalidArgumentException
     */
     ...
     * @throws \BigCommerce\Api\ApiException on non-2xx response
     * @throws \InvalidArgumentException
     * @return array of \BigCommerce\Api\Model\ProductVideoCollectionResponse, HTTP status code, HTTP response headers (array of strings)
     */
    public function getProductVideosWithHttpInfo($product_id, array $params = [])
    {
        ...
        try {
            list($response, $statusCode, $httpHeader) = $this->apiClient->callApi(
                ...
                $httpBody,
                $headerParams,
                '\BigCommerce\Api\Model\ProductVideoCollectionResponse',
                '/catalog/products/{product_id}/videos'
            );
            return [$this->apiClient->getSerializer()->deserialize($response, '\BigCommerce\Api\Model\ProductVideoCollectionResponse', $httpHeader), $statusCode, $httpHeader];

         } catch (ApiException $e) {
            switch ($e->getCode()) {
            
                case 200:
                $data = $this->apiClient->getSerializer()->deserialize($e->getResponseBody(), '\BigCommerce\Api\Model\ProductVideoCollectionResponse', $e->getResponseHeaders());
                $e->setResponseObject($data);
                break;
     ...
     * @return \BigCommerce\Api\Model\ProductCollectionResponse
     * @throws \BigCommerce\Api\ApiException on non-2xx response
     * @throws \InvalidArgumentException
     */
     ...
     * @throws \BigCommerce\Api\ApiException on non-2xx response
     * @throws \InvalidArgumentException
     * @return array of \BigCommerce\Api\Model\ProductCollectionResponse, HTTP status code, HTTP response headers (array of strings)
     */
    public function getProductsWithHttpInfo(array $params = [])
    {
        ...
        try {
            list($response, $statusCode, $httpHeader) = $this->apiClient->callApi(
                ...
                $httpBody,
                $headerParams,
                '\BigCommerce\Api\Model\ProductCollectionResponse',
                '/catalog/products'
            );
            return [$this->apiClient->getSerializer()->deserialize($response, '\BigCommerce\Api\Model\ProductCollectionResponse', $httpHeader), $statusCode, $httpHeader];

         } catch (ApiException $e) {
            switch ($e->getCode()) {
            
                case 200:
                $data = $this->apiClient->getSerializer()->deserialize($e->getResponseBody(), '\BigCommerce\Api\Model\ProductCollectionResponse', $e->getResponseHeaders());
                $e->setResponseObject($data);
                break;
     ...
     *     - include_fields string Fields to include, in a comma-separated list. The ID and the specified fields will be returned. (optional)
     *     - exclude_fields string Fields to exclude, in a comma-separated list. The specified fields will be excluded from a response. The ID cannot be excluded. (optional)
     * @return \BigCommerce\Api\Model\VariantCollectionResponse
     * @throws \BigCommerce\Api\ApiException on non-2xx response
     * @throws \InvalidArgumentException
     */
     ...
     * @throws \BigCommerce\Api\ApiException on non-2xx response
     * @throws \InvalidArgumentException
     * @return array of \BigCommerce\Api\Model\VariantCollectionResponse, HTTP status code, HTTP response headers (array of strings)
     */
    public function getVariantsWithHttpInfo(array $params = [])
    {
        ...
        try {
            list($response, $statusCode, $httpHeader) = $this->apiClient->callApi(
                ...
                $httpBody,
                $headerParams,
                '\BigCommerce\Api\Model\VariantCollectionResponse',
                '/catalog/variants'
            );
            return [$this->apiClient->getSerializer()->deserialize($response, '\BigCommerce\Api\Model\VariantCollectionResponse', $httpHeader), $statusCode, $httpHeader];

         } catch (ApiException $e) {
            switch ($e->getCode()) {
            
                case 200:
                $data = $this->apiClient->getSerializer()->deserialize($e->getResponseBody(), '\BigCommerce\Api\Model\VariantCollectionResponse', $e->getResponseHeaders());
                $e->setResponseObject($data);
                break;
     ...
     *
     * @param int $brand_id The ID of the &#x60;Brand&#x60; to which the resource belongs. (required)
     * @param \BigCommerce\Api\Model\BrandPut $brand Returns a &#x60;Brand&#x60; from the BigCommerce Catalog. (required)
     * @param array $params = []
     * @return \BigCommerce\Api\Model\BrandResponse
     * @throws \BigCommerce\Api\ApiException on non-2xx response
     * @throws \InvalidArgumentException
     ...
     * @param int $metafield_id The ID of the &#x60;Metafield&#x60;. (required)
     * @param int $brand_id The ID of the &#x60;Brand&#x60; to which the resource belongs. (required)
     * @param \BigCommerce\Api\Model\MetafieldPut $metafield A &#x60;Metafield&#x60; object. (required)
     * @param array $params = []
     * @return \BigCommerce\Api\Model\MetafieldResponse
     * @throws \BigCommerce\Api\ApiException on non-2xx response
     * @throws \InvalidArgumentException
     ...
     * @param int $product_id The ID of the &#x60;Product&#x60; to which the resource belongs. (required)
     * @param int $bulk_pricing_rule_id The ID of the &#x60;BulkPricingRule&#x60;. (required)
     * @param \BigCommerce\Api\Model\BulkPricingRulePut $bulk_pricing_rule &#x60;BulkPricingRule&#x60; object. (required)
     * @param array $params = []
     * @return \BigCommerce\Api\Model\BulkPricingRuleResponse
     * @throws \BigCommerce\Api\ApiException on non-2xx response
     * @throws \InvalidArgumentException
     ...
     *
     * @param int $category_id The ID of the &#x60;Category&#x60; to which the resource belongs. (required)
     * @param \BigCommerce\Api\Model\CategoryPut $category A BigCommerce &#x60;Category&#x60; object. (required)
     * @param array $params = []
     * @return \BigCommerce\Api\Model\CategoryResponse
     * @throws \BigCommerce\Api\ApiException on non-2xx response
     * @throws \InvalidArgumentException
     ...
     * @param int $product_id The ID of the &#x60;Product&#x60; to which the resource belongs. (required)
     * @param int $complex_rule_id The ID of the &#x60;ComplexRule&#x60;. (required)
     * @param \BigCommerce\Api\Model\ComplexRulePut $complex_rule &#x60;ComplexRule&#x60; object. (required)
     * @param array $params = []
     * @return \BigCommerce\Api\Model\ComplexRuleResponse
     * @throws \BigCommerce\Api\ApiException on non-2xx response
     * @throws \InvalidArgumentException
     ...
     * @param int $product_id The ID of the &#x60;Product&#x60; to which the resource belongs. (required)
     * @param int $configurable_field_id The ID of the &#x60;ConfigurableField&#x60;. (required)
     * @param \BigCommerce\Api\Model\ConfigurableFieldPut $configurable_field &#x60;ConfigurableField&#x60; object. (required)
     * @param array $params = []
     * @return \BigCommerce\Api\Model\ConfigurableFieldResponse
     * @throws \BigCommerce\Api\ApiException on non-2xx response
     * @throws \InvalidArgumentException
     ...
     * @param int $product_id The ID of the &#x60;Product&#x60; to which the resource belongs. (required)
     * @param int $custom_field_id The ID of the &#x60;CustomField&#x60;. (required)
     * @param \BigCommerce\Api\Model\CustomFieldPut $custom_field &#x60;CustomField&#x60; object. (required)
     * @param array $params = []
     * @return \BigCommerce\Api\Model\CustomFieldResponse
     * @throws \BigCommerce\Api\ApiException on non-2xx response
     * @throws \InvalidArgumentException
     ...
     * @param int $product_id The ID of the &#x60;Product&#x60; to which the resource belongs. (required)
     * @param int $modifier_id The ID of the &#x60;Modifier&#x60;. (required)
     * @param \BigCommerce\Api\Model\ModifierPut $modifier A BigCommerce &#x60;Modifier&#x60; object. (required)
     * @param array $params = []
     * @return \BigCommerce\Api\Model\ModifierResponse
     * @throws \BigCommerce\Api\ApiException on non-2xx response
     * @throws \InvalidArgumentException
     ...
     * @param int $modifier_id The ID of the &#x60;Modifier&#x60;. (required)
     * @param int $value_id The ID of the &#x60;Modifier/Option Value&#x60;. (required)
     * @param \BigCommerce\Api\Model\ModifierValuePut $modifier_value A BigCommerce &#x60;ModifierValue&#x60; object. (required)
     * @param array $params = []
     * @return \BigCommerce\Api\Model\ModifierValueResponse
     * @throws \BigCommerce\Api\ApiException on non-2xx response
     * @throws \InvalidArgumentException
     ...
     * @param int $product_id The ID of the &#x60;Product&#x60; to which the resource belongs. (required)
     * @param int $option_id The ID of the &#x60;Option&#x60;. (required)
     * @param \BigCommerce\Api\Model\OptionPut $option A BigCommerce &#x60;Option&#x60; object. (required)
     * @param array $params = []
     * @return \BigCommerce\Api\Model\OptionResponse
     * @throws \BigCommerce\Api\ApiException on non-2xx response
     * @throws \InvalidArgumentException
     ...
     * @param int $option_id The ID of the &#x60;Option&#x60;. (required)
     * @param int $value_id The ID of the &#x60;Modifier/Option Value&#x60;. (required)
     * @param \BigCommerce\Api\Model\OptionValuePut $option_value A BigCommerce &#x60;OptionValue&#x60; object. (required)
     * @param array $params = []
     * @return \BigCommerce\Api\Model\OptionValueResponse
     * @throws \BigCommerce\Api\ApiException on non-2xx response
     * @throws \InvalidArgumentException
     ...
     *
     * @param int $product_id The ID of the &#x60;Product&#x60; to which the resource belongs. (required)
     * @param \BigCommerce\Api\Model\ProductPut $product A BigCommerce &#x60;Product&#x60; object. (required)
     * @param array $params = []
     * @return \BigCommerce\Api\Model\ProductResponse
     * @throws \BigCommerce\Api\ApiException on non-2xx response
     * @throws \InvalidArgumentException
     ...
     * @param int $product_id The ID of the &#x60;Product&#x60; to which the resource belongs. (required)
     * @param int $image_id The ID of the &#x60;Image&#x60; that is being operated on. (required)
     * @param \BigCommerce\Api\Model\ProductImagePut $product_image A BigCommerce &#x60;ProductImage&#x60; object. (required)
     * @param array $params = []
     * @return \BigCommerce\Api\Model\ProductImageResponse
     * @throws \BigCommerce\Api\ApiException on non-2xx response
     * @throws \InvalidArgumentException
     ...
     * @param int $product_id The ID of the &#x60;Product&#x60; to which the resource belongs. (required)
     * @param int $review_id The ID of the &#x60;review&#x60; that is being operated on. (required)
     * @param \BigCommerce\Api\Model\ProductReviewPut $product_review A BigCommerce &#x60;ProductReview&#x60; object. (required)
     * @param array $params = []
     * @return \BigCommerce\Api\Model\ProductReviewResponse
     * @throws \BigCommerce\Api\ApiException on non-2xx response
     * @throws \InvalidArgumentException
     ...
     * @param int $product_id The ID of the &#x60;Product&#x60; to which the resource belongs. (required)
     * @param string $video_id The ID of the &#x60;Video&#x60; that is being operated on. (required)
     * @param \BigCommerce\Api\Model\ProductVideoPut $product_video A BigCommerce &#x60;ProductVideo&#x60; object. (required)
     * @param array $params = []
     * @return \BigCommerce\Api\Model\ProductVideoResponse
     * @throws \BigCommerce\Api\ApiException on non-2xx response
     * @throws \InvalidArgumentException
     ...
     * @param int $product_id The ID of the &#x60;Product&#x60; to which the resource belongs. (required)
     * @param int $variant_id ID of the variant on a product, or on an associated Price List Record. (required)
     * @param \BigCommerce\Api\Model\VariantPut $variant A &#x60;Variant&#x60; object. (required)
     * @param array $params = []
     * @return \BigCommerce\Api\Model\VariantResponse
     * @throws \BigCommerce\Api\ApiException on non-2xx response
     * @throws \InvalidArgumentException
