...
class Product extends ProductBase implements ArrayAccess
{
    ...
    protected static $swaggerTypes = [
        ...
        'custom_url' => '\BigCommerce\Api\Model\CustomUrlProduct',
        ...
        'reviews_count' => 'int',
        'total_sold' => 'int',
        'custom_fields' => '\BigCommerce\Api\Model\CustomField[]',
        'bulk_pricing_rules' => '\BigCommerce\Api\Model\BulkPricingRule[]',
        'date_created' => '\DateTime',
        'date_modified' => '\DateTime',
        'images' => '\BigCommerce\Api\Model\ProductImage[]',
        'videos' => '\BigCommerce\Api\Model\ProductVideo[]',
        'variants' => '\BigCommerce\Api\Model\Variant[]',
        'options' => '\BigCommerce\Api\Model\Option[]',
        'modifiers' => '\BigCommerce\Api\Model\Modifier[]',
        'base_variant_id' => 'int'
    ];
    ...
    public function __construct(array $data = [])
    {
        ...
        $this->container['reviews_rating_sum'] = array_key_exists('reviews_rating_sum', $data) ? $data['reviews_rating_sum'] : null;
        $this->container['reviews_count'] = array_key_exists('reviews_count', $data) ? $data['reviews_count'] : null;
        $this->container['total_sold'] = array_key_exists('total_sold', $data) ? $data['total_sold'] : null;
    ...
    {
        if (strlen($sku) > 255) {
            throw new \InvalidArgumentException('invalid length for $sku when calling Product., must be smaller than or equal to 255.');
        }
        if (strlen($sku) < 0) {
    ...
    public function setWeight($weight)
    {
        ...
        if ($weight > 9999999999) {
            throw new \InvalidArgumentException('invalid value for $weight when calling Product., must be smaller than or equal to 9999999999.');
        }
        if ($weight < 0) {
    ...
    public function setWidth($width)
    {
        ...
        if ($width > 9999999999) {
            throw new \InvalidArgumentException('invalid value for $width when calling Product., must be smaller than or equal to 9999999999.');
        }
        if ($width < 0) {
            throw new \InvalidArgumentException('invalid value for $width when calling Product., must be bigger than or equal to 0.');
        }
    ...
    public function setDepth($depth)
    {
        ...
        if ($depth > 9999999999) {
            throw new \InvalidArgumentException('invalid value for $depth when calling Product., must be smaller than or equal to 9999999999.');
        }
        if ($depth < 0) {
            throw new \InvalidArgumentException('invalid value for $depth when calling Product., must be bigger than or equal to 0.');
        }
    ...
    public function setHeight($height)
    {
        ...
        if ($height > 9999999999) {
            throw new \InvalidArgumentException('invalid value for $height when calling Product., must be smaller than or equal to 9999999999.');
        }
        if ($height < 0) {
            throw new \InvalidArgumentException('invalid value for $height when calling Product., must be bigger than or equal to 0.');
        }
    ...
    public function setCostPrice($cost_price)
    {
        ...
        if ($cost_price < 0) {
            throw new \InvalidArgumentException('invalid value for $cost_price when calling Product., must be bigger than or equal to 0.');
        }
    ...
    public function setRetailPrice($retail_price)
    {
        ...
        if ($retail_price < 0) {
            throw new \InvalidArgumentException('invalid value for $retail_price when calling Product., must be bigger than or equal to 0.');
        }
    ...
    public function setSalePrice($sale_price)
    {
        ...
        if ($sale_price < 0) {
            throw new \InvalidArgumentException('invalid value for $sale_price when calling Product., must be bigger than or equal to 0.');
        }
    ...
    public function setTaxClassId($tax_class_id)
    {
        ...
        if ($tax_class_id > 1000000000) {
            throw new \InvalidArgumentException('invalid value for $tax_class_id when calling Product., must be smaller than or equal to 1000000000.');
        }
        if ($tax_class_id < 0) {
            throw new \InvalidArgumentException('invalid value for $tax_class_id when calling Product., must be bigger than or equal to 0.');
        }
    ...
    public function setProductTaxCode($product_tax_code)
    {
        if (strlen($product_tax_code) > 255) {
            throw new \InvalidArgumentException('invalid length for $product_tax_code when calling Product., must be smaller than or equal to 255.');
        }
        if (strlen($product_tax_code) < 0) {
            throw new \InvalidArgumentException('invalid length for $product_tax_code when calling Product., must be bigger than or equal to 0.');
        }
    ...
    public function setBrandId($brand_id)
    {
        ...
        if ($brand_id > 1000000000) {
            throw new \InvalidArgumentException('invalid value for $brand_id when calling Product., must be smaller than or equal to 1000000000.');
        }
        if ($brand_id < 0) {
            throw new \InvalidArgumentException('invalid value for $brand_id when calling Product., must be bigger than or equal to 0.');
        }
    ...
    public function setInventoryLevel($inventory_level)
    {
        ...
        if ($inventory_level > 1000000000) {
            throw new \InvalidArgumentException('invalid value for $inventory_level when calling Product., must be smaller than or equal to 1000000000.');
        }
        if ($inventory_level < 0) {
            throw new \InvalidArgumentException('invalid value for $inventory_level when calling Product., must be bigger than or equal to 0.');
        }
    ...
    public function setInventoryWarningLevel($inventory_warning_level)
    {
        ...
        if ($inventory_warning_level > 1000000000) {
            throw new \InvalidArgumentException('invalid value for $inventory_warning_level when calling Product., must be smaller than or equal to 1000000000.');
        }
        if ($inventory_warning_level < 0) {
            throw new \InvalidArgumentException('invalid value for $inventory_warning_level when calling Product., must be bigger than or equal to 0.');
        }
    ...
    public function setFixedCostShippingPrice($fixed_cost_shipping_price)
    {
        ...
        if ($fixed_cost_shipping_price < 0) {
            throw new \InvalidArgumentException('invalid value for $fixed_cost_shipping_price when calling Product., must be bigger than or equal to 0.');
        }
    ...
    public function setWarranty($warranty)
    {
        if (strlen($warranty) > 65535) {
            throw new \InvalidArgumentException('invalid length for $warranty when calling Product., must be smaller than or equal to 65535.');
        }
        if (strlen($warranty) < 0) {
            throw new \InvalidArgumentException('invalid length for $warranty when calling Product., must be bigger than or equal to 0.');
        }
    ...
    public function setBinPickingNumber($bin_picking_number)
    {
        if (strlen($bin_picking_number) > 255) {
            throw new \InvalidArgumentException('invalid length for $bin_picking_number when calling Product., must be smaller than or equal to 255.');
        }
        if (strlen($bin_picking_number) < 0) {
            throw new \InvalidArgumentException('invalid length for $bin_picking_number when calling Product., must be bigger than or equal to 0.');
        }
    ...
    public function setLayoutFile($layout_file)
    {
        if (strlen($layout_file) > 500) {
            throw new \InvalidArgumentException('invalid length for $layout_file when calling Product., must be smaller than or equal to 500.');
        }
        if (strlen($layout_file) < 0) {
            throw new \InvalidArgumentException('invalid length for $layout_file when calling Product., must be bigger than or equal to 0.');
        }
    ...
    {
        if (strlen($upc) > 255) {
            throw new \InvalidArgumentException('invalid length for $upc when calling Product., must be smaller than or equal to 255.');
        }
        if (strlen($upc) < 0) {
            throw new \InvalidArgumentException('invalid length for $upc when calling Product., must be bigger than or equal to 0.');
        }
    ...
    public function setSearchKeywords($search_keywords)
    {
        if (strlen($search_keywords) > 65535) {
            throw new \InvalidArgumentException('invalid length for $search_keywords when calling Product., must be smaller than or equal to 65535.');
        }
        if (strlen($search_keywords) < 0) {
            throw new \InvalidArgumentException('invalid length for $search_keywords when calling Product., must be bigger than or equal to 0.');
        }
    ...
    public function setAvailabilityDescription($availability_description)
    {
        if (strlen($availability_description) > 255) {
            throw new \InvalidArgumentException('invalid length for $availability_description when calling Product., must be smaller than or equal to 255.');
        }
        if (strlen($availability_description) < 0) {
            throw new \InvalidArgumentException('invalid length for $availability_description when calling Product., must be bigger than or equal to 0.');
        }
    ...
    public function setSortOrder($sort_order)
    {
        ...
        if ($sort_order > 2147483647) {
            throw new \InvalidArgumentException('invalid value for $sort_order when calling Product., must be smaller than or equal to 2147483647.');
        }
        if ($sort_order < -2147483648) {
            throw new \InvalidArgumentException('invalid value for $sort_order when calling Product., must be bigger than or equal to -2147483648.');
        }
    ...
    public function setOrderQuantityMinimum($order_quantity_minimum)
    {
        ...
        if ($order_quantity_minimum > 1000000000) {
            throw new \InvalidArgumentException('invalid value for $order_quantity_minimum when calling Product., must be smaller than or equal to 1000000000.');
        }
        if ($order_quantity_minimum < 0) {
            throw new \InvalidArgumentException('invalid value for $order_quantity_minimum when calling Product., must be bigger than or equal to 0.');
        }
    ...
    public function setOrderQuantityMaximum($order_quantity_maximum)
    {
        ...
        if ($order_quantity_maximum > 1000000000) {
            throw new \InvalidArgumentException('invalid value for $order_quantity_maximum when calling Product., must be smaller than or equal to 1000000000.');
        }
        if ($order_quantity_maximum < 0) {
            throw new \InvalidArgumentException('invalid value for $order_quantity_maximum when calling Product., must be bigger than or equal to 0.');
        }
    ...
    public function setPageTitle($page_title)
    {
        if (strlen($page_title) > 255) {
            throw new \InvalidArgumentException('invalid length for $page_title when calling Product., must be smaller than or equal to 255.');
        }
        if (strlen($page_title) < 0) {
            throw new \InvalidArgumentException('invalid length for $page_title when calling Product., must be bigger than or equal to 0.');
        }
    ...
    public function setMetaDescription($meta_description)
    {
        if (strlen($meta_description) > 65535) {
            throw new \InvalidArgumentException('invalid length for $meta_description when calling Product., must be smaller than or equal to 65535.');
        }
        if (strlen($meta_description) < 0) {
            throw new \InvalidArgumentException('invalid length for $meta_description when calling Product., must be bigger than or equal to 0.');
        }
    ...
    public function setViewCount($view_count)
    {
        ...
        if ($view_count > 1000000000) {
            throw new \InvalidArgumentException('invalid value for $view_count when calling Product., must be smaller than or equal to 1000000000.');
        }
        if ($view_count < 0) {
            throw new \InvalidArgumentException('invalid value for $view_count when calling Product., must be bigger than or equal to 0.');
        }
    ...
    public function setPreorderMessage($preorder_message)
    {
        if (strlen($preorder_message) > 255) {
            throw new \InvalidArgumentException('invalid length for $preorder_message when calling Product., must be smaller than or equal to 255.');
        }
        if (strlen($preorder_message) < 0) {
            throw new \InvalidArgumentException('invalid length for $preorder_message when calling Product., must be bigger than or equal to 0.');
        }
    ...
    public function setPriceHiddenLabel($price_hidden_label)
    {
        if (strlen($price_hidden_label) > 200) {
            throw new \InvalidArgumentException('invalid length for $price_hidden_label when calling Product., must be smaller than or equal to 200.');
        }
        if (strlen($price_hidden_label) < 0) {
            throw new \InvalidArgumentException('invalid length for $price_hidden_label when calling Product., must be bigger than or equal to 0.');
        }
    ...
    /**
     * Gets custom_url
     * @return \BigCommerce\Api\Model\CustomUrlProduct
     */
    ...
    /**
     * Sets custom_url
     * @param \BigCommerce\Api\Model\CustomUrlProduct $custom_url
     * @return $this
     */
    ...
    /**
     * Sets id
     * @param int $id The unique numeric ID of the product; increments sequentially.
     * @return $this
     */
     ...
     * @param double $calculated_price The price of the product as seen on the storefront. It will be equal to the `sale_price`, if set, and the `price` if there is not a `sale_price`.
     * @return $this
     */
    ...
    /**
     * Gets custom_fields
     * @return \BigCommerce\Api\Model\CustomField[]
     */
    ...
    /**
     * Sets custom_fields
     * @param \BigCommerce\Api\Model\CustomField[] $custom_fields
     * @return $this
     */
     ...
     * @return \BigCommerce\Api\Model\BulkPricingRule[]
     */
     ...
     * @param \BigCommerce\Api\Model\BulkPricingRule[] $bulk_pricing_rules
     * @return $this
     */
    ...
    /**
     * Gets images
     * @return \BigCommerce\Api\Model\ProductImage[]
     */
    ...
    /**
     * Sets images
     * @param \BigCommerce\Api\Model\ProductImage[] $images
     * @return $this
     */
    ...
    /**
     * Gets videos
     * @return \BigCommerce\Api\Model\ProductVideo[]
     */
    ...
    /**
     * Sets videos
     * @param \BigCommerce\Api\Model\ProductVideo[] $videos
     * @return $this
     */
    ...
    /**
     * Gets variants
     * @return \BigCommerce\Api\Model\Variant[]
     */
    ...
    /**
     * Sets variants
     * @param \BigCommerce\Api\Model\Variant[] $variants
     * @return $this
     */
    ...
    /**
     * Gets options
     * @return \BigCommerce\Api\Model\Option[]
     */
    ...
    /**
     * Sets options
     * @param \BigCommerce\Api\Model\Option[] $options
     * @return $this
     */
    ...
    /**
     * Gets modifiers
     * @return \BigCommerce\Api\Model\Modifier[]
     */
    ...
    /**
     * Sets modifiers
     * @param \BigCommerce\Api\Model\Modifier[] $modifiers
     * @return $this
     */
