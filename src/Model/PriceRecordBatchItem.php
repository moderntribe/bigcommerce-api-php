...
class PriceRecordBatchItem extends PriceRecordBase implements ArrayAccess
{
    ...
    protected static $swaggerTypes = [
        ...
        'retail_price' => 'double',
        'map_price' => 'double',
        'bulk_pricing_tiers' => '\BigCommerce\Api\Model\BulkPricingTier[]',
        'sku' => 'string',
        'variant_id' => 'int',
        'currency' => 'string'
    ];
     ...
     * @param \BigCommerce\Api\Model\BulkPricingTier[] $bulk_pricing_tiers
     * @return $this
     */
    ...
    /**
     * Sets sku
     * @param string $sku The sku for the variant with which this price set is associated.  Either sku or variant_id is required.
     * @return $this
     */
