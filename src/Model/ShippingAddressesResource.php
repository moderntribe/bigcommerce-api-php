...
class ShippingAddressesResource implements ArrayAccess
{
    ...
    /**
      ...
      * @var string
      */
    protected static $swaggerModelName = 'ShippingAddressesResource';
    ...
    /**
     * Sets url
     * @param string $url URL of the shipping address for api requests
     * @return $this
     */
