...
class PricingRequestItem implements ArrayAccess
{
    ...
    /**
     * Sets options
     * @param \BigCommerce\Api\Model\PricingRequestItemOption[] $options The (optional) option configuration of the product. May be \"partially\" configured for estimates.
     * @return $this
     */
