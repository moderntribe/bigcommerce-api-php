...
class Activate implements ArrayAccess
{
    ...
    {
        $this->container['variation_id'] = array_key_exists('variation_id', $data) ? $data['variation_id'] : null;
    ...
    public function listInvalidProperties()
    {
        ...
        if ($this->container['variation_id'] === null) {
            $invalid_properties[] = "'variation_id' can't be null";
        }
        if ($this->container['which'] === null) {
            $invalid_properties[] = "'which' can't be null";
        }
