...
class BrandPost extends BrandBase implements ArrayAccess
{
    ...
    /**
      ...
      * @var string
      */
    protected static $swaggerModelName = 'BrandPost';
    ...
    protected static $swaggerTypes = [
        ...
        'image_url' => 'string',
        'custom_url' => '\BigCommerce\Api\Model\CustomUrlBrand'
    ];
    ...
    {
        if (strlen($name) > 255) {
            throw new \InvalidArgumentException('invalid length for $name when calling BrandPost., must be smaller than or equal to 255.');
        }
        if (strlen($name) < 1) {
            throw new \InvalidArgumentException('invalid length for $name when calling BrandPost., must be bigger than or equal to 1.');
        }
    ...
    public function setPageTitle($page_title)
    {
        if (strlen($page_title) > 255) {
            throw new \InvalidArgumentException('invalid length for $page_title when calling BrandPost., must be smaller than or equal to 255.');
        }
        if (strlen($page_title) < 0) {
            throw new \InvalidArgumentException('invalid length for $page_title when calling BrandPost., must be bigger than or equal to 0.');
        }
    ...
    public function setMetaDescription($meta_description)
    {
        if (strlen($meta_description) > 65535) {
            throw new \InvalidArgumentException('invalid length for $meta_description when calling BrandPost., must be smaller than or equal to 65535.');
        }
        if (strlen($meta_description) < 0) {
            throw new \InvalidArgumentException('invalid length for $meta_description when calling BrandPost., must be bigger than or equal to 0.');
        }
    ...
    public function setSearchKeywords($search_keywords)
    {
        if (strlen($search_keywords) > 65535) {
            throw new \InvalidArgumentException('invalid length for $search_keywords when calling BrandPost., must be smaller than or equal to 65535.');
        }
        if (strlen($search_keywords) < 0) {
            throw new \InvalidArgumentException('invalid length for $search_keywords when calling BrandPost., must be bigger than or equal to 0.');
        }
    ...
    /**
     * Gets custom_url
     * @return \BigCommerce\Api\Model\CustomUrlBrand
     */
    ...
    /**
     * Sets custom_url
     * @param \BigCommerce\Api\Model\CustomUrlBrand $custom_url
     * @return $this
     */
