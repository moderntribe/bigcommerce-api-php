...
class BulkPricingRulePost extends BulkPricingRuleBase implements ArrayAccess
{
    ...
    /**
      ...
      * @var string
      */
    protected static $swaggerModelName = 'BulkPricingRulePost';
    ...
    public function setQuantityMin($quantity_min)
    {
        ...
        if ($quantity_min < 0) {
            throw new \InvalidArgumentException('invalid value for $quantity_min when calling BulkPricingRulePost., must be bigger than or equal to 0.');
        }
    ...
    public function setQuantityMax($quantity_max)
    {
        ...
        if ($quantity_max < 0) {
            throw new \InvalidArgumentException('invalid value for $quantity_max when calling BulkPricingRulePost., must be bigger than or equal to 0.');
        }
    ...
    public function setAmount($amount)
    {
        ...
        if ($amount < 0) {
            throw new \InvalidArgumentException('invalid value for $amount when calling BulkPricingRulePost., must be bigger than or equal to 0.');
        }
