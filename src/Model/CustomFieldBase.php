...
class CustomFieldBase implements ArrayAccess
{
    ...
    /**
      ...
      * @var string
      */
    protected static $swaggerModelName = 'CustomFieldBase';
    ...
    {
        if (strlen($name) > 250) {
            throw new \InvalidArgumentException('invalid length for $name when calling CustomFieldBase., must be smaller than or equal to 250.');
        }
        if (strlen($name) < 1) {
            throw new \InvalidArgumentException('invalid length for $name when calling CustomFieldBase., must be bigger than or equal to 1.');
        }
    ...
    {
        if (strlen($value) > 250) {
            throw new \InvalidArgumentException('invalid length for $value when calling CustomFieldBase., must be smaller than or equal to 250.');
        }
        if (strlen($value) < 1) {
            throw new \InvalidArgumentException('invalid length for $value when calling CustomFieldBase., must be bigger than or equal to 1.');
        }
