...
class OrderCouponsResource implements ArrayAccess
{
    ...
    /**
      ...
      * @var string
      */
    protected static $swaggerModelName = 'OrderCouponsResource';
    ...
    /**
     * Sets url
     * @param string $url URL of the coupons for api requests
     * @return $this
     */
    ...
    /**
     * Sets resource
     * @param string $resource resource of the coupons
     * @return $this
     */
