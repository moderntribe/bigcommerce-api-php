...
class OrderProduct implements ArrayAccess
{
    ...
    protected static $swaggerTypes = [
        ...
        'applied_discounts' => '\BigCommerce\Api\Model\OrderProductAppliedDiscounts[]',
        'product_options' => '\BigCommerce\Api\Model\OrderProductOptions[]',
        'external_id' => 'int',
        'upc' => 'string',
        'variant_id' => 'int'
    ];
    ...
    public function __construct(array $data = [])
    {
        ...
        $this->container['base_price'] = array_key_exists('base_price', $data) ? $data['base_price'] : null;
        $this->container['price_ex_tax'] = array_key_exists('price_ex_tax', $data) ? $data['price_ex_tax'] : null;
        $this->container['price_inc_tax'] = array_key_exists('price_inc_tax', $data) ? $data['price_inc_tax'] : null;
        $this->container['price_tax'] = array_key_exists('price_tax', $data) ? $data['price_tax'] : null;
        $this->container['base_total'] = array_key_exists('base_total', $data) ? $data['base_total'] : null;
        ...
        $this->container['base_cost_price'] = array_key_exists('base_cost_price', $data) ? $data['base_cost_price'] : null;
        $this->container['cost_price_inc_tax'] = array_key_exists('cost_price_inc_tax', $data) ? $data['cost_price_inc_tax'] : null;
        $this->container['cost_price_ex_tax'] = array_key_exists('cost_price_ex_tax', $data) ? $data['cost_price_ex_tax'] : null;
        $this->container['weight'] = array_key_exists('weight', $data) ? $data['weight'] : null;
        $this->container['cost_price_tax'] = array_key_exists('cost_price_tax', $data) ? $data['cost_price_tax'] : null;
        $this->container['is_refunded'] = array_key_exists('is_refunded', $data) ? $data['is_refunded'] : null;
        $this->container['refunded_amount'] = array_key_exists('refunded_amount', $data) ? $data['refunded_amount'] : null;
        $this->container['return_id'] = array_key_exists('return_id', $data) ? $data['return_id'] : null;
        $this->container['wrapping_name'] = array_key_exists('wrapping_name', $data) ? $data['wrapping_name'] : null;
        ...
        $this->container['wrapping_message'] = array_key_exists('wrapping_message', $data) ? $data['wrapping_message'] : null;
        $this->container['quantity_shipped'] = array_key_exists('quantity_shipped', $data) ? $data['quantity_shipped'] : null;
        $this->container['event_name'] = array_key_exists('event_name', $data) ? $data['event_name'] : null;
        $this->container['event_date'] = array_key_exists('event_date', $data) ? $data['event_date'] : null;
        $this->container['fixed_shipping_cost'] = array_key_exists('fixed_shipping_cost', $data) ? $data['fixed_shipping_cost'] : null;
        $this->container['ebay_item_id'] = array_key_exists('ebay_item_id', $data) ? $data['ebay_item_id'] : null;
        $this->container['ebay_transaction_id'] = array_key_exists('ebay_transaction_id', $data) ? $data['ebay_transaction_id'] : null;
        $this->container['option_set_id'] = array_key_exists('option_set_id', $data) ? $data['option_set_id'] : null;
        $this->container['parent_order_product_id'] = array_key_exists('parent_order_product_id', $data) ? $data['parent_order_product_id'] : null;
        $this->container['is_bundled_product'] = array_key_exists('is_bundled_product', $data) ? $data['is_bundled_product'] : null;
        $this->container['bin_picking_number'] = array_key_exists('bin_picking_number', $data) ? $data['bin_picking_number'] : null;
        $this->container['applied_discounts'] = array_key_exists('applied_discounts', $data) ? $data['applied_discounts'] : null;
        $this->container['product_options'] = array_key_exists('product_options', $data) ? $data['product_options'] : null;
     ...
     * @return \BigCommerce\Api\Model\OrderProductAppliedDiscounts[]
     */
     ...
     * @param \BigCommerce\Api\Model\OrderProductAppliedDiscounts[] $applied_discounts Array of objects containing discounts applied to the product.
     * @return $this
     */
     ...
     * @return \BigCommerce\Api\Model\OrderProductOptions[]
     */
     ...
     * @param \BigCommerce\Api\Model\OrderProductOptions[] $product_options Array of product option objects.
     * @return $this
     */
    ...
    {
        if (strlen($upc) > 255) {
            throw new \InvalidArgumentException('invalid length for $upc when calling OrderProduct., must be smaller than or equal to 255.');
        }
