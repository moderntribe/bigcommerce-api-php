...
class Site implements ArrayAccess
{
    ...
    protected static $swaggerTypes = [
        ...
        'created_at' => 'string',
        'updated_at' => 'string',
        'routes' => '\BigCommerce\Api\Model\Route[]'
    ];
    ...
    /**
     * Sets routes
     * @param \BigCommerce\Api\Model\Route[] $routes (optional - if included) collection of routes defined for this site. Limited to 200 routes side loaded (query routes direction via `/routes` for bulk)
     * @return $this
     */
