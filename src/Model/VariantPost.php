...
class VariantPost extends VariantBase implements ArrayAccess
{
    ...
    /**
      ...
      * @var string
      */
    protected static $swaggerModelName = 'VariantPost';
    ...
    protected static $swaggerTypes = [
        ...
        'product_id' => 'int',
        'sku' => 'string',
        'option_values' => '\BigCommerce\Api\Model\OptionValueVariantPost[]'
    ];
    ...
    public function setCostPrice($cost_price)
    {
        ...
        if ($cost_price < 0) {
            throw new \InvalidArgumentException('invalid value for $cost_price when calling VariantPost., must be bigger than or equal to 0.');
        }
    ...
    public function setPrice($price)
    {
        ...
        if ($price < 0) {
            throw new \InvalidArgumentException('invalid value for $price when calling VariantPost., must be bigger than or equal to 0.');
        }
    ...
    public function setSalePrice($sale_price)
    {
        ...
        if ($sale_price < 0) {
            throw new \InvalidArgumentException('invalid value for $sale_price when calling VariantPost., must be bigger than or equal to 0.');
        }
    ...
    public function setRetailPrice($retail_price)
    {
        ...
        if ($retail_price < 0) {
            throw new \InvalidArgumentException('invalid value for $retail_price when calling VariantPost., must be bigger than or equal to 0.');
        }
    ...
    public function setWeight($weight)
    {
        ...
        if ($weight < 0) {
            throw new \InvalidArgumentException('invalid value for $weight when calling VariantPost., must be bigger than or equal to 0.');
        }
    ...
    public function setWidth($width)
    {
        ...
        if ($width < 0) {
            throw new \InvalidArgumentException('invalid value for $width when calling VariantPost., must be bigger than or equal to 0.');
        }
    ...
    public function setHeight($height)
    {
        ...
        if ($height < 0) {
            throw new \InvalidArgumentException('invalid value for $height when calling VariantPost., must be bigger than or equal to 0.');
        }
    ...
    public function setDepth($depth)
    {
        ...
        if ($depth < 0) {
            throw new \InvalidArgumentException('invalid value for $depth when calling VariantPost., must be bigger than or equal to 0.');
        }
    ...
    public function setFixedCostShippingPrice($fixed_cost_shipping_price)
    {
        ...
        if ($fixed_cost_shipping_price < 0) {
            throw new \InvalidArgumentException('invalid value for $fixed_cost_shipping_price when calling VariantPost., must be bigger than or equal to 0.');
        }
    ...
    public function setPurchasingDisabledMessage($purchasing_disabled_message)
    {
        if (strlen($purchasing_disabled_message) > 255) {
            throw new \InvalidArgumentException('invalid length for $purchasing_disabled_message when calling VariantPost., must be smaller than or equal to 255.');
        }
        if (strlen($purchasing_disabled_message) < 0) {
            throw new \InvalidArgumentException('invalid length for $purchasing_disabled_message when calling VariantPost., must be bigger than or equal to 0.');
        }
    ...
    public function setBinPickingNumber($bin_picking_number)
    {
        if (strlen($bin_picking_number) > 255) {
            throw new \InvalidArgumentException('invalid length for $bin_picking_number when calling VariantPost., must be smaller than or equal to 255.');
        }
        if (strlen($bin_picking_number) < 0) {
            throw new \InvalidArgumentException('invalid length for $bin_picking_number when calling VariantPost., must be bigger than or equal to 0.');
        }
    ...
    {
        if (strlen($sku) > 255) {
            throw new \InvalidArgumentException('invalid length for $sku when calling VariantPost., must be smaller than or equal to 255.');
        }
        if (strlen($sku) < 1) {
            throw new \InvalidArgumentException('invalid length for $sku when calling VariantPost., must be bigger than or equal to 1.');
        }
    ...
    /**
     * Gets option_values
     * @return \BigCommerce\Api\Model\OptionValueVariantPost[]
     */
    ...
    /**
     * Sets option_values
     * @param \BigCommerce\Api\Model\OptionValueVariantPost[] $option_values Array of option and option values IDs that make up this variant. Will be empty if the variant is the product's base variant.
     * @return $this
     */
