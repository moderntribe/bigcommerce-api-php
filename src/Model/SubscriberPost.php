...
class SubscriberPost extends SubscriberBase implements ArrayAccess
{
    ...
    /**
      ...
      * @var string
      */
    protected static $swaggerModelName = 'SubscriberPost';
    ...
    public function setFirstName($first_name)
    {
        if (strlen($first_name) > 255) {
            throw new \InvalidArgumentException('invalid length for $first_name when calling SubscriberPost., must be smaller than or equal to 255.');
        }
        if (strlen($first_name) < 0) {
            throw new \InvalidArgumentException('invalid length for $first_name when calling SubscriberPost., must be bigger than or equal to 0.');
        }
    ...
    public function setLastName($last_name)
    {
        if (strlen($last_name) > 255) {
            throw new \InvalidArgumentException('invalid length for $last_name when calling SubscriberPost., must be smaller than or equal to 255.');
        }
        if (strlen($last_name) < 0) {
            throw new \InvalidArgumentException('invalid length for $last_name when calling SubscriberPost., must be bigger than or equal to 0.');
        }
    ...
    public function setSource($source)
    {
        if (strlen($source) > 255) {
            throw new \InvalidArgumentException('invalid length for $source when calling SubscriberPost., must be smaller than or equal to 255.');
        }
        if (strlen($source) < 0) {
            throw new \InvalidArgumentException('invalid length for $source when calling SubscriberPost., must be bigger than or equal to 0.');
        }
    ...
    public function setOrderId($order_id)
    {
        ...
        if ($order_id > 2147483647) {
            throw new \InvalidArgumentException('invalid value for $order_id when calling SubscriberPost., must be smaller than or equal to 2147483647.');
        }
        if ($order_id < 1) {
            throw new \InvalidArgumentException('invalid value for $order_id when calling SubscriberPost., must be bigger than or equal to 1.');
        }
