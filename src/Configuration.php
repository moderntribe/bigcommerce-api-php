...
class Configuration
{
     ...
     * @var string
     */
    protected $host = 'https://api.bigcommerce.com/stores/{store_id}/v3';
    ...
    {
        $report  = 'PHP SDK (BigCommerce\Api) Debug Report:' . PHP_EOL;
        $report .= '    OS: ' . php_uname() . PHP_EOL;
        $report .= '    PHP Version: ' . phpversion() . PHP_EOL;
        $report .= '    OpenAPI Spec Version: 3.0.0b' . PHP_EOL;
