...
/**
 * ReceivedItemsPutInner Class Doc Comment
 *
 * @category Class
 * @package  BigCommerce\OrdersV3
 * @author   Swagger Codegen team
 * @link     https://github.com/swagger-api/swagger-codegen
 */
class ReceivedItemsPutInner implements ModelInterface, ArrayAccess
{
    ...
    /**
      ...
      * @var string
      */
    protected static $swaggerModelName = 'ReceivedItems_Put_inner';
...
'pending_quantity' => 'getPendingQuantity'    ];
     ...
     * Sets item_id
     *
     * @param int $item_id The ID of the item for which to update the received state
     *
     * @return $this
     */
     ...
     *
     * @param int $received_quantity The quantity of items to be marked as received
     *
     * @return $this
     */
