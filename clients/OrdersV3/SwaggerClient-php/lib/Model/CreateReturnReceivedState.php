...
/**
 * CreateReturnReceivedState Class Doc Comment
 *
 * @category Class
 * @package  BigCommerce\OrdersV3
 * @author   Swagger Codegen team
 * @link     https://github.com/swagger-api/swagger-codegen
 */
class CreateReturnReceivedState implements ModelInterface, ArrayAccess
{
    ...
    /**
      ...
      * @var string
      */
    protected static $swaggerModelName = 'CreateReturn_received_state';
...
'pending_quantity' => 'getPendingQuantity'    ];
     ...
     *
     * @param int $received_quantity The quantity of items marked as received by the merchant
     *
     * @return $this
     */
