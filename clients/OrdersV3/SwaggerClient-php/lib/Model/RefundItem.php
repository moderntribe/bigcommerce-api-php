...
class RefundItem implements ModelInterface, ArrayAccess
{
    ...
    /**
      ...
      * @var string
      */
    protected static $swaggerModelName = 'Refund Item';
...
self::ITEM_TYPE_ORDER,        ];
     ...
     * Sets item_type
     *
     * @param string $item_type Type of item that was refunded
     *
     * @return $this
     */
     ...
     * Sets item_id
     *
     * @param int $item_id Reference to the item
     *
     * @return $this
     */
     ...
     * Sets reason
     *
     * @param string $reason Reason for refunding an item
     *
     * @return $this
     */
     ...
     * Sets quantity
     *
     * @param int $quantity Quantity of item refunded. Note: this will only be populated for item_type PRODUCT
     *
     * @return $this
     */
     ...
     *
     * @param float $requested_amount A non-negative 2 decimal place rounded value that represents that amount that can be charged/refunded via payment providers
     *
     * @return $this
     */
