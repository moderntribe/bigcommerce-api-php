...
/**
 * CreateReturnReason Class Doc Comment
 *
 * @category Class
 * @package  BigCommerce\OrdersV3
 * @author   Swagger Codegen team
 * @link     https://github.com/swagger-api/swagger-codegen
 */
class CreateReturnReason implements ModelInterface, ArrayAccess
{
    ...
    /**
      ...
      * @var string
      */
    protected static $swaggerModelName = 'CreateReturn_reason';
...
'label' => 'getLabel'    ];
     ...
     * Sets id
     *
     * @param int $id Unique identifier of the reason
     *
     * @return $this
     */
     ...
     * Sets label
     *
     * @param string $label A displayable label for the reason
     *
     * @return $this
     */
