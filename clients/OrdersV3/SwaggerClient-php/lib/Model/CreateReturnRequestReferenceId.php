...
/**
 * CreateReturnRequestReferenceId Class Doc Comment
 *
 * @category Class
 * @package  BigCommerce\OrdersV3
 * @author   Swagger Codegen team
 * @link     https://github.com/swagger-api/swagger-codegen
 */
class CreateReturnRequestReferenceId implements ModelInterface, ArrayAccess
{
    ...
    /**
      ...
      * @var string
      */
    protected static $swaggerModelName = 'CreateReturnRequest_reference_id';
...
'value' => 'getValue'    ];
    ...
    const TYPE_PRODUCT = 'ORDER_PRODUCT';
     ...
     * Sets value
     *
     * @param string $value The value identifying the returned item
     *
     * @return $this
     */
