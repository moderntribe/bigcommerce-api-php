...
/**
 * ReceivedItemsBaseInner Class Doc Comment
 *
 * @category Class
 * @package  BigCommerce\OrdersV3
 * @author   Swagger Codegen team
 * @link     https://github.com/swagger-api/swagger-codegen
 */
class ReceivedItemsBaseInner implements ModelInterface, ArrayAccess
{
    ...
    /**
      ...
      * @var string
      */
    protected static $swaggerModelName = 'ReceivedItems_Base_inner';
...
'pending_quantity' => 'getPendingQuantity'    ];
     ...
     * Sets item_id
     *
     * @param int $item_id The ID of the item for which received item status was updated
     *
     * @return $this
     */
     ...
     *
     * @param int $received_quantity The quantity of items marked as received
     *
     * @return $this
     */
