...
class CreateReturnRequest implements ModelInterface, ArrayAccess
{
    ...
    protected static $swaggerTypes = [
        'items' => '\BigCommerce\OrdersV3\Model\CreateReturnRequestItems[]',
'comment' => 'string'    ];
...
'comment' => 'getComment'    ];
     ...
     * Gets items
     *
     * @return \BigCommerce\OrdersV3\Model\CreateReturnRequestItems[]
     */
     ...
     * Sets items
     *
     * @param \BigCommerce\OrdersV3\Model\CreateReturnRequestItems[] $items A collection of items to be returned
     *
     * @return $this
     */
