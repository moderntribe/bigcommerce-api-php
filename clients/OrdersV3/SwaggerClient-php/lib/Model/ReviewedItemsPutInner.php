...
/**
 * ReviewedItemsPutInner Class Doc Comment
 *
 * @category Class
 * @package  BigCommerce\OrdersV3
 * @author   Swagger Codegen team
 * @link     https://github.com/swagger-api/swagger-codegen
 */
class ReviewedItemsPutInner implements ModelInterface, ArrayAccess
{
    ...
    /**
      ...
      * @var string
      */
    protected static $swaggerModelName = 'ReviewedItems_Put_inner';
...
'pending_quantity' => 'pending_quantity'    ];
    ...
    protected static $setters = [
        'item_id' => 'setItemId',
'authorized_quantity' => 'setAuthorizedQuantity',
...
'pending_quantity' => 'setPendingQuantity'    ];
    ...
    protected static $getters = [
        'item_id' => 'getItemId',
'authorized_quantity' => 'getAuthorizedQuantity',
...
'pending_quantity' => 'getPendingQuantity'    ];
    ...
    public function __construct(array $data = null)
    {
        ...
        $this->container['authorized_quantity'] = isset($data['authorized_quantity']) ? $data['authorized_quantity'] : null;
    ...
    public function listInvalidProperties()
    {
        ...
        if ($this->container['authorized_quantity'] === null) {
            $invalidProperties[] = "'authorized_quantity' can't be null";
        }
        if ($this->container['rejected_quantity'] === null) {
            $invalidProperties[] = "'rejected_quantity' can't be null";
        }
     ...
     * Sets item_id
     *
     * @param int $item_id The ID of the item for which to update the reviewed state
     *
     * @return $this
     */
    ...
    /**
     * Gets authorized_quantity
     *
     * @return int
     */
    public function getAuthorizedQuantity()
    {
        return $this->container['authorized_quantity'];
    }

    /**
     * Sets authorized_quantity
     *
     * @param int $authorized_quantity The quantity of items to be marked as authorized
     *
     * @return $this
     */
    public function setAuthorizedQuantity($authorized_quantity)
    {
        $this->container['authorized_quantity'] = $authorized_quantity;
     ...
     *
     * @param int $rejected_quantity The quantity of items to be marked as rejected
     *
     * @return $this
     */
     ...
     *
     * @param int $pending_quantity The quantity of items to be marked as pending
     *
     * @return $this
     */
