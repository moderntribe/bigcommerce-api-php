...
/**
 * StatusUpdateFull1 Class Doc Comment
 *
 * @category Class
 * @package  BigCommerce\OrdersV3
 * @author   Swagger Codegen team
 * @link     https://github.com/swagger-api/swagger-codegen
 */
class StatusUpdateFull1 implements ModelInterface, ArrayAccess
{
    ...
    /**
      ...
      * @var string
      */
    protected static $swaggerModelName = 'StatusUpdate_Full_1';
...
'new_status' => 'getNewStatus'    ];
    ...
    const NEW_STATUS_CLOSED = 'CLOSED';
const NEW_STATUS_OPEN = 'OPEN';
const NEW_STATUS_REMOVED = 'REMOVED';
    ...
    {
        return [
            self::NEW_STATUS_CLOSED,
self::NEW_STATUS_OPEN,
self::NEW_STATUS_REMOVED,        ];
    }
    ...
    public function listInvalidProperties()
    {
        ...
        if (!is_null($this->container['new_status']) && !in_array($this->container['new_status'], $allowedValues, true)) {
            $invalidProperties[] = sprintf(
                "invalid value for 'new_status', must be one of '%s'",
     ...
     * Sets return_id
     *
     * @param int $return_id The ID of the return for which the status should be updated
     *
     * @return $this
     */
     ...
     * Sets new_status
     *
     * @param string $new_status The status of the return.
     *
     * @return $this
     */
    ...
    {
        $allowedValues = $this->getNewStatusAllowableValues();
        if (!is_null($new_status) && !in_array($new_status, $allowedValues, true)) {
