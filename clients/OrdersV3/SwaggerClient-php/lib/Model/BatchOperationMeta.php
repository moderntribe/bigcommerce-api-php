...
/**
 * BatchOperationMeta Class Doc Comment
 *
 * @category Class
 * @package  BigCommerce\OrdersV3
 * @author   Swagger Codegen team
 * @link     https://github.com/swagger-api/swagger-codegen
 */
class BatchOperationMeta implements ModelInterface, ArrayAccess
{
    ...
    /**
      ...
      * @var string
      */
    protected static $swaggerModelName = 'BatchOperationMeta';
...
'failed' => 'getFailed'    ];
     ...
     * Sets total
     *
     * @param int $total The total number of operations in the batch
     *
     * @return $this
     */
     ...
     * Sets success
     *
     * @param int $success The number of failed operations in the batch
     *
     * @return $this
     */
     ...
     * Sets failed
     *
     * @param int $failed The number of failed operations in the batch
     *
     * @return $this
     */
