...
/**
 * RefundQuotePost1 Class Doc Comment
 *
 * @category Class
 ...
 * @link     https://github.com/swagger-api/swagger-codegen
 */
class RefundQuotePost1 implements ModelInterface, ArrayAccess
{
    ...
    /**
      ...
      * @var string
      */
    protected static $swaggerModelName = 'RefundQuote_Post_1';
...
'items' => 'getItems'    ];
     ...
     * Sets order_id
     *
     * @param int $order_id Order ID against which this refund will be created. This is optional for creating a single refund request. The order ID is included in the request path.
     *
     * @return $this
     */
