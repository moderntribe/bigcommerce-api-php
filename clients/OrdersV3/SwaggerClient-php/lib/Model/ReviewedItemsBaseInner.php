...
/**
 * ReviewedItemsBaseInner Class Doc Comment
 *
 * @category Class
 * @package  BigCommerce\OrdersV3
 * @author   Swagger Codegen team
 * @link     https://github.com/swagger-api/swagger-codegen
 */
class ReviewedItemsBaseInner implements ModelInterface, ArrayAccess
{
    ...
    /**
      ...
      * @var string
      */
    protected static $swaggerModelName = 'ReviewedItems_Base_inner';
...
'pending_quantity' => 'getPendingQuantity'    ];
     ...
     * Sets item_id
     *
     * @param int $item_id The ID of the item for which reviewed status was updated
     *
     * @return $this
     */
     ...
     *
     * @param int $authorized_quantity The quantity of items marked as authorized
     *
     * @return $this
     */
     ...
     *
     * @param int $rejected_quantity The quantity of items marked as rejected
     *
     * @return $this
     */
     ...
     *
     * @param int $pending_quantity The quantity of items marked as pending
     *
     * @return $this
     */
