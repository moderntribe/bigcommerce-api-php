...
/**
 * CreateReturnPreferredOutcome Class Doc Comment
 *
 * @category Class
 * @package  BigCommerce\OrdersV3
 * @author   Swagger Codegen team
 * @link     https://github.com/swagger-api/swagger-codegen
 */
class CreateReturnPreferredOutcome implements ModelInterface, ArrayAccess
{
    ...
    /**
      ...
      * @var string
      */
    protected static $swaggerModelName = 'CreateReturn_preferred_outcome';
...
'label' => 'getLabel'    ];
     ...
     * Sets id
     *
     * @param int $id Unique identifier of the preferred outcome
     *
     * @return $this
     */
     ...
     * Sets label
     *
     * @param string $label A displayable label for the preferred outcome
     *
     * @return $this
     */
