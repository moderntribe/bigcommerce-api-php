...
/**
 * UpdateReturnStatusesInner Class Doc Comment
 *
 * @category Class
 * @package  BigCommerce\OrdersV3
 * @author   Swagger Codegen team
 * @link     https://github.com/swagger-api/swagger-codegen
 */
class UpdateReturnStatusesInner implements ModelInterface, ArrayAccess
{
    ...
    /**
      ...
      * @var string
      */
    protected static $swaggerModelName = 'UpdateReturnStatuses_inner';
...
self::STATUS_REMOVED,        ];
     ...
     * Sets id
     *
     * @param int $id The ID of the return for which the status was updated
     *
     * @return $this
     */
