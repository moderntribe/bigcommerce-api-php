...
/**
 * OrderTaxesApi Class Doc Comment
 *
 * @category Class
 * @package  BigCommerce\OrdersV2
 * @author   Swagger Codegen team
...
class OrderTaxesApi
{
     ...
     * @param  string $details To return detailed tax information, pass in the details query. (optional, default to true)
     *
     * @throws \BigCommerce\OrdersV2\ApiException on non-2xx response
     * @throws \InvalidArgumentException
     * @return \BigCommerce\OrdersV2\Model\OrderTaxesBase1[]
     */
    public function getOrderTaxes($order_id, $accept, $content_type, $page = null, $limit = null, $details = 'true')
    {
        list($response) = $this->getOrderTaxesWithHttpInfo($order_id, $accept, $content_type, $page, $limit, $details);
        return $response;
    }
     ...
     * @throws \BigCommerce\OrdersV2\ApiException on non-2xx response
     * @throws \InvalidArgumentException
     * @return array of \BigCommerce\OrdersV2\Model\OrderTaxesBase1[], HTTP status code, HTTP response headers (array of strings)
     */
    public function getOrderTaxesWithHttpInfo($order_id, $accept, $content_type, $page = null, $limit = null, $details = 'true')
    {
        $returnType = '\BigCommerce\OrdersV2\Model\OrderTaxesBase1[]';
        $request = $this->getOrderTaxesRequest($order_id, $accept, $content_type, $page, $limit, $details);
            ...
            switch ($e->getCode()) {
                case 200:
                    $data = ObjectSerializer::deserialize(
                        $e->getResponseBody(),
                        '\BigCommerce\OrdersV2\Model\OrderTaxesBase1[]',
     ...
     */
    public function getOrderTaxesAsync($order_id, $accept, $content_type, $page = null, $limit = null, $details = 'true')
    {
        return $this->getOrderTaxesAsyncWithHttpInfo($order_id, $accept, $content_type, $page, $limit, $details)
            ->then(
                function ($response) {
                    return $response[0];
                }
    ...
    /**
     * Operation getOrderTaxesAsyncWithHttpInfo
     *
     * Get All Order Taxes
     *
     * @param  int $order_id ID of the order (required)
     ...
     * @return \GuzzleHttp\Promise\PromiseInterface
     */
    public function getOrderTaxesAsyncWithHttpInfo($order_id, $accept, $content_type, $page = null, $limit = null, $details = 'true')
    {
        $returnType = '\BigCommerce\OrdersV2\Model\OrderTaxesBase1[]';
        $request = $this->getOrderTaxesRequest($order_id, $accept, $content_type, $page, $limit, $details);
    ...
    /**
     * Create request for operation 'getOrderTaxes'
     *
     * @param  int $order_id ID of the order (required)
     * @param  string $accept (required)
     * @param  string $content_type (required)
     ...
     */
    protected function getOrderTaxesRequest($order_id, $accept, $content_type, $page = null, $limit = null, $details = 'true')
    {
        // verify the required parameter 'order_id' is set
        if ($order_id === null || (is_array($order_id) && count($order_id) === 0)) {
            throw new \InvalidArgumentException(
                'Missing the required parameter $order_id when calling getOrderTaxes'
            );
        }
        // verify the required parameter 'accept' is set
        if ($accept === null || (is_array($accept) && count($accept) === 0)) {
            throw new \InvalidArgumentException(
                'Missing the required parameter $accept when calling getOrderTaxes'
            );
        }
        // verify the required parameter 'content_type' is set
        if ($content_type === null || (is_array($content_type) && count($content_type) === 0)) {
            throw new \InvalidArgumentException(
                'Missing the required parameter $content_type when calling getOrderTaxes'
            );
        }
