...
/**
 * OrderStatusOrderStatuses Class Doc Comment
 *
 * @category Class
 * @package  BigCommerce\OrdersV2
 * @author   Swagger Codegen team
 * @link     https://github.com/swagger-api/swagger-codegen
 */
class OrderStatusOrderStatuses implements ModelInterface, ArrayAccess
{
    ...
    /**
      ...
      * @var string
      */
    protected static $swaggerModelName = 'orderStatus_OrderStatuses';
     ...
     * Sets order
     *
     * @param int $order The sort order of the order status from the Control Panel
     *
     * @return $this
     */
