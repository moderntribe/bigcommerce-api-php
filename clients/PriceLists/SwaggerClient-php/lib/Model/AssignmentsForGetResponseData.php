...
/**
 * AssignmentsForGetResponseData Class Doc Comment
 *
 * @category Class
 * @package  BigCommerce\PriceLists
 * @author   Swagger Codegen team
 * @link     https://github.com/swagger-api/swagger-codegen
 */
class AssignmentsForGetResponseData implements ModelInterface, ArrayAccess
{
    ...
    /**
      ...
      * @var string
      */
    protected static $swaggerModelName = 'AssignmentsForGetResponse_data';
...
'channel_id' => 'getChannelId'    ];
     ...
     * Sets id
     *
     * @param int $id Unique identifier for this price list assignment.
     *
     * @return $this
     */
     ...
     *
     * @param int $customer_group_id Customer group id for assignment.
     *
     * @return $this
     */
     ...
     * Sets price_list_id
     *
     * @param int $price_list_id Pricelist id for assignment.
     *
     * @return $this
     */
     ...
     * Sets channel_id
     *
     * @param int $channel_id Channel ID for assignment
     *
     * @return $this
     */
