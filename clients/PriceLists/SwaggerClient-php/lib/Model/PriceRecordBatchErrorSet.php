 ...
 * @link     https://github.com/swagger-api/swagger-codegen
 */
class PriceRecordBatchErrorSet implements ModelInterface, ArrayAccess
{
    ...
    /**
      ...
      * @var string
      */
    protected static $swaggerModelName = 'PriceRecord Batch Error Set';
    ...
    protected static $swaggerTypes = [
        'data' => 'AllOfPriceRecordBatchErrorSetData',
...
'field_errors' => 'getFieldErrors'    ];
     ...
     * Gets data
     *
     * @return AllOfPriceRecordBatchErrorSetData
     */
     ...
     * Sets data
     *
     * @param AllOfPriceRecordBatchErrorSetData $data Price Record object used in batch create or update.
     *
     * @return $this
     */
