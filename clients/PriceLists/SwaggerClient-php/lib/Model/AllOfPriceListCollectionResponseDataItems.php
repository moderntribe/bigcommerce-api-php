...
/**
 * AllOfPriceListCollectionResponseDataItems Class Doc Comment
 *
 * @category Class
 * @package  BigCommerce\PriceLists
 * @author   Swagger Codegen team
 * @link     https://github.com/swagger-api/swagger-codegen
 */
class AllOfPriceListCollectionResponseDataItems implements ModelInterface, ArrayAccess
{
    ...
    /**
      ...
      * @var string
      */
    protected static $swaggerModelName = 'AllOfPriceList Collection ResponseDataItems';
...
'active' => 'getActive'    ];
     ...
     * Sets name
     *
     * @param string $name The unique name of the Price List. Required in /POST.
     *
     * @return $this
     */
