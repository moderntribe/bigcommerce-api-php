...
class PriceRecordBatchErrorResponse implements ModelInterface, ArrayAccess
{
    ...
    /**
      ...
      * @var string
      */
    protected static $swaggerModelName = 'PriceRecord Batch Error Response';
    ...
    protected static $swaggerTypes = [
        'batch_errors' => '\BigCommerce\PriceLists\Model\PriceRecordBatchErrorSet[]'    ];
     ...
     * Gets batch_errors
     *
     * @return \BigCommerce\PriceLists\Model\PriceRecordBatchErrorSet[]
     */
     ...
     * Sets batch_errors
     *
     * @param \BigCommerce\PriceLists\Model\PriceRecordBatchErrorSet[] $batch_errors batch_errors
     *
     * @return $this
     */
