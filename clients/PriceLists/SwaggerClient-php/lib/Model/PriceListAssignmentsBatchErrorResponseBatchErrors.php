...
/**
 * PriceListAssignmentsBatchErrorResponseBatchErrors Class Doc Comment
 *
 * @category Class
 ...
 * @link     https://github.com/swagger-api/swagger-codegen
 */
class PriceListAssignmentsBatchErrorResponseBatchErrors implements ModelInterface, ArrayAccess
{
    ...
    /**
      ...
      * @var string
      */
    protected static $swaggerModelName = 'PriceListAssignmentsBatchErrorResponse_batch_errors';
    ...
    protected static $swaggerTypes = [
        'data' => 'AllOfPriceListAssignmentsBatchErrorResponseBatchErrorsData',
...
'field_errors' => 'getFieldErrors'    ];
     ...
     * Gets data
     *
     * @return AllOfPriceListAssignmentsBatchErrorResponseBatchErrorsData
     */
     ...
     * Sets data
     *
     * @param AllOfPriceListAssignmentsBatchErrorResponseBatchErrorsData $data `Price List Assignments` object used in GET response.
     *
     * @return $this
     */
     ...
     * Sets field_errors
     *
     * @param map[string,string] $field_errors field_errors
     *
     * @return $this
     */
