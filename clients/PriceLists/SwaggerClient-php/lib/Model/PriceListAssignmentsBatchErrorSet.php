...
/**
 * PriceListAssignmentsBatchErrorSet Class Doc Comment
 *
 * @category Class
 ...
 * @link     https://github.com/swagger-api/swagger-codegen
 */
class PriceListAssignmentsBatchErrorSet implements ModelInterface, ArrayAccess
{
    ...
    /**
      ...
      * @var string
      */
    protected static $swaggerModelName = 'PriceListAssignmentsBatchErrorSet';
    ...
    protected static $swaggerTypes = [
        'data' => 'AllOfPriceListAssignmentsBatchErrorSetData',
...
'field_errors' => 'getFieldErrors'    ];
     ...
     * Gets data
     *
     * @return AllOfPriceListAssignmentsBatchErrorSetData
     */
     ...
     * Sets data
     *
     * @param AllOfPriceListAssignmentsBatchErrorSetData $data `Price List Assignments` object used in GET response.
     *
     * @return $this
     */
