...
class ProductVideosApi
{
     ...
     *
     * @param  \BigCommerce\Catalog\Model\ProductVideoPost $body body (required)
     ...
     * @return \BigCommerce\Catalog\Model\ProductVideoResponse
     */
    public function createProductVideo($body, $accept, $content_type, $product_id)
    {
        list($response) = $this->createProductVideoWithHttpInfo($body, $accept, $content_type, $product_id);
        return $response;
    }
     ...
     * Create a Product Video
     *
     * @param  \BigCommerce\Catalog\Model\ProductVideoPost $body (required)
     ...
     * @throws \BigCommerce\Catalog\ApiException on non-2xx response
     * @throws \InvalidArgumentException
     * @return array of \BigCommerce\Catalog\Model\ProductVideoResponse, HTTP status code, HTTP response headers (array of strings)
     */
    public function createProductVideoWithHttpInfo($body, $accept, $content_type, $product_id)
    {
        $returnType = '\BigCommerce\Catalog\Model\ProductVideoResponse';
        $request = $this->createProductVideoRequest($body, $accept, $content_type, $product_id);
            ...
            switch ($e->getCode()) {
                case 200:
                    $data = ObjectSerializer::deserialize(
                        $e->getResponseBody(),
                        '\BigCommerce\Catalog\Model\ProductVideoResponse',
     ...
     */
    public function createProductVideoAsync($body, $accept, $content_type, $product_id)
    {
        return $this->createProductVideoAsyncWithHttpInfo($body, $accept, $content_type, $product_id)
            ->then(
                function ($response) {
                    return $response[0];
                }
     ...
     * @return \GuzzleHttp\Promise\PromiseInterface
     */
    public function createProductVideoAsyncWithHttpInfo($body, $accept, $content_type, $product_id)
    {
        $returnType = '\BigCommerce\Catalog\Model\ProductVideoResponse';
        $request = $this->createProductVideoRequest($body, $accept, $content_type, $product_id);
     ...
     */
    protected function createProductVideoRequest($body, $accept, $content_type, $product_id)
    {
        // verify the required parameter 'body' is set
        if ($body === null || (is_array($body) && count($body) === 0)) {
            throw new \InvalidArgumentException(
                'Missing the required parameter $body when calling createProductVideo'
            );
        }
     ...
     * @throws \BigCommerce\Catalog\ApiException on non-2xx response
     * @throws \InvalidArgumentException
     * @return \BigCommerce\Catalog\Model\ProductVideoResponse1
     */
     ...
     * @throws \BigCommerce\Catalog\ApiException on non-2xx response
     * @throws \InvalidArgumentException
     * @return array of \BigCommerce\Catalog\Model\ProductVideoResponse1, HTTP status code, HTTP response headers (array of strings)
     */
    ...
    {
        $returnType = '\BigCommerce\Catalog\Model\ProductVideoResponse1';
        ...
        try {
            ...
            switch ($e->getCode()) {
                case 200:
                    $data = ObjectSerializer::deserialize(
                        $e->getResponseBody(),
                        '\BigCommerce\Catalog\Model\ProductVideoResponse1',
                        $e->getResponseHeaders()
                    );
                    $e->setResponseObject($data);
                    break;
     ...
     * @throws \BigCommerce\Catalog\ApiException on non-2xx response
     * @throws \InvalidArgumentException
     * @return \BigCommerce\Catalog\Model\ProductVideoCollectionResponse
     */
     ...
     * @throws \BigCommerce\Catalog\ApiException on non-2xx response
     * @throws \InvalidArgumentException
     * @return array of \BigCommerce\Catalog\Model\ProductVideoCollectionResponse, HTTP status code, HTTP response headers (array of strings)
     */
    public function getProductVideosWithHttpInfo($product_id, $accept, $content_type, $include_fields = null, $exclude_fields = null)
    {
        $returnType = '\BigCommerce\Catalog\Model\ProductVideoCollectionResponse';
        ...
        try {
            ...
            switch ($e->getCode()) {
                case 200:
                    $data = ObjectSerializer::deserialize(
                        $e->getResponseBody(),
                        '\BigCommerce\Catalog\Model\ProductVideoCollectionResponse',
                        $e->getResponseHeaders()
                    );
                    $e->setResponseObject($data);
                    break;
     ...
     *
     * @param  \BigCommerce\Catalog\Model\ProductVideoPut $body body (required)
     * @param  string $accept accept (required)
     * @param  string $content_type content_type (required)
     * @param  int $product_id The ID of the &#x60;Product&#x60; to which the resource belongs. (required)
     * @param  int $id The BigCommerce ID of the &#x60;Video&#x60; (required)
     ...
     * @return \BigCommerce\Catalog\Model\ProductVideoResponse
     */
    public function updateProductVideo($body, $accept, $content_type, $product_id, $id)
    {
        list($response) = $this->updateProductVideoWithHttpInfo($body, $accept, $content_type, $product_id, $id);
        return $response;
    }
     ...
     * Update a Product Video
     *
     * @param  \BigCommerce\Catalog\Model\ProductVideoPut $body (required)
     * @param  string $accept (required)
     * @param  string $content_type (required)
     * @param  int $product_id The ID of the &#x60;Product&#x60; to which the resource belongs. (required)
     * @param  int $id The BigCommerce ID of the &#x60;Video&#x60; (required)
     ...
     * @return array of \BigCommerce\Catalog\Model\ProductVideoResponse, HTTP status code, HTTP response headers (array of strings)
     */
    public function updateProductVideoWithHttpInfo($body, $accept, $content_type, $product_id, $id)
    {
        $returnType = '\BigCommerce\Catalog\Model\ProductVideoResponse';
        $request = $this->updateProductVideoRequest($body, $accept, $content_type, $product_id, $id);
     ...
     * @return \GuzzleHttp\Promise\PromiseInterface
     */
    public function updateProductVideoAsync($body, $accept, $content_type, $product_id, $id)
    {
        return $this->updateProductVideoAsyncWithHttpInfo($body, $accept, $content_type, $product_id, $id)
            ->then(
                function ($response) {
                    return $response[0];
                }
     ...
     * @return \GuzzleHttp\Promise\PromiseInterface
     */
    public function updateProductVideoAsyncWithHttpInfo($body, $accept, $content_type, $product_id, $id)
    {
        $returnType = '\BigCommerce\Catalog\Model\ProductVideoResponse';
        $request = $this->updateProductVideoRequest($body, $accept, $content_type, $product_id, $id);
     ...
     * @return \GuzzleHttp\Psr7\Request
     */
    protected function updateProductVideoRequest($body, $accept, $content_type, $product_id, $id)
    {
        // verify the required parameter 'body' is set
        if ($body === null || (is_array($body) && count($body) === 0)) {
            throw new \InvalidArgumentException(
                'Missing the required parameter $body when calling updateProductVideo'
            );
        }
        // verify the required parameter 'accept' is set
        if ($accept === null || (is_array($accept) && count($accept) === 0)) {
