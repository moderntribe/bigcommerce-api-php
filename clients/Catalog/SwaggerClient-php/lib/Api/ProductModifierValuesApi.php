...
class ProductModifierValuesApi
{
     ...
     *
     * @param  \BigCommerce\Catalog\Model\ModifierValuePost $body body (required)
     ...
     * @return \BigCommerce\Catalog\Model\ModifierValueResponse
     */
    public function createModifierValue($body, $accept, $content_type, $product_id, $modifier_id)
    {
        list($response) = $this->createModifierValueWithHttpInfo($body, $accept, $content_type, $product_id, $modifier_id);
        return $response;
    }
     ...
     * Create Modifier Value
     *
     * @param  \BigCommerce\Catalog\Model\ModifierValuePost $body (required)
     ...
     * @throws \BigCommerce\Catalog\ApiException on non-2xx response
     * @throws \InvalidArgumentException
     * @return array of \BigCommerce\Catalog\Model\ModifierValueResponse, HTTP status code, HTTP response headers (array of strings)
     */
    public function createModifierValueWithHttpInfo($body, $accept, $content_type, $product_id, $modifier_id)
    {
        $returnType = '\BigCommerce\Catalog\Model\ModifierValueResponse';
        $request = $this->createModifierValueRequest($body, $accept, $content_type, $product_id, $modifier_id);
            ...
            switch ($e->getCode()) {
                case 200:
                    $data = ObjectSerializer::deserialize(
                        $e->getResponseBody(),
                        '\BigCommerce\Catalog\Model\ModifierValueResponse',
     ...
     */
    public function createModifierValueAsync($body, $accept, $content_type, $product_id, $modifier_id)
    {
        return $this->createModifierValueAsyncWithHttpInfo($body, $accept, $content_type, $product_id, $modifier_id)
            ->then(
                function ($response) {
                    return $response[0];
                }
     ...
     * @return \GuzzleHttp\Promise\PromiseInterface
     */
    public function createModifierValueAsyncWithHttpInfo($body, $accept, $content_type, $product_id, $modifier_id)
    {
        $returnType = '\BigCommerce\Catalog\Model\ModifierValueResponse';
        $request = $this->createModifierValueRequest($body, $accept, $content_type, $product_id, $modifier_id);
     ...
     */
    protected function createModifierValueRequest($body, $accept, $content_type, $product_id, $modifier_id)
    {
        // verify the required parameter 'body' is set
        if ($body === null || (is_array($body) && count($body) === 0)) {
            throw new \InvalidArgumentException(
                'Missing the required parameter $body when calling createModifierValue'
            );
        }
     ...
     * @throws \BigCommerce\Catalog\ApiException on non-2xx response
     * @throws \InvalidArgumentException
     * @return \BigCommerce\Catalog\Model\ModifierValueResponse1
     */
     ...
     * @throws \BigCommerce\Catalog\ApiException on non-2xx response
     * @throws \InvalidArgumentException
     * @return array of \BigCommerce\Catalog\Model\ModifierValueResponse1, HTTP status code, HTTP response headers (array of strings)
     */
    ...
    {
        $returnType = '\BigCommerce\Catalog\Model\ModifierValueResponse1';
        ...
        try {
            ...
            switch ($e->getCode()) {
                case 200:
                    $data = ObjectSerializer::deserialize(
                        $e->getResponseBody(),
                        '\BigCommerce\Catalog\Model\ModifierValueResponse1',
                        $e->getResponseHeaders()
                    );
                    $e->setResponseObject($data);
                    break;
     ...
     * @throws \BigCommerce\Catalog\ApiException on non-2xx response
     * @throws \InvalidArgumentException
     * @return \BigCommerce\Catalog\Model\ModifierValueCollectionResponse
     */
     ...
     * @throws \BigCommerce\Catalog\ApiException on non-2xx response
     * @throws \InvalidArgumentException
     * @return array of \BigCommerce\Catalog\Model\ModifierValueCollectionResponse, HTTP status code, HTTP response headers (array of strings)
     */
    ...
    {
        $returnType = '\BigCommerce\Catalog\Model\ModifierValueCollectionResponse';
        ...
        try {
            ...
            switch ($e->getCode()) {
                case 200:
                    $data = ObjectSerializer::deserialize(
                        $e->getResponseBody(),
                        '\BigCommerce\Catalog\Model\ModifierValueCollectionResponse',
                        $e->getResponseHeaders()
                    );
                    $e->setResponseObject($data);
                    break;
     ...
     *
     * @param  \BigCommerce\Catalog\Model\ModifierValuePut $body body (required)
     * @param  string $accept accept (required)
     * @param  string $content_type content_type (required)
     * @param  int $product_id The ID of the &#x60;Product&#x60; to which the resource belongs. (required)
     * @param  int $modifier_id The ID of the &#x60;Modifier&#x60;. (required)
     ...
     * @return \BigCommerce\Catalog\Model\ModifierValueResponse
     */
    public function updateModifierValue($body, $accept, $content_type, $product_id, $modifier_id, $value_id)
    {
        list($response) = $this->updateModifierValueWithHttpInfo($body, $accept, $content_type, $product_id, $modifier_id, $value_id);
        return $response;
    }
     ...
     * Update a Modifier Value
     *
     * @param  \BigCommerce\Catalog\Model\ModifierValuePut $body (required)
     * @param  string $accept (required)
     * @param  string $content_type (required)
     * @param  int $product_id The ID of the &#x60;Product&#x60; to which the resource belongs. (required)
     * @param  int $modifier_id The ID of the &#x60;Modifier&#x60;. (required)
     ...
     * @return array of \BigCommerce\Catalog\Model\ModifierValueResponse, HTTP status code, HTTP response headers (array of strings)
     */
    public function updateModifierValueWithHttpInfo($body, $accept, $content_type, $product_id, $modifier_id, $value_id)
    {
        $returnType = '\BigCommerce\Catalog\Model\ModifierValueResponse';
        $request = $this->updateModifierValueRequest($body, $accept, $content_type, $product_id, $modifier_id, $value_id);
     ...
     * @return \GuzzleHttp\Promise\PromiseInterface
     */
    public function updateModifierValueAsync($body, $accept, $content_type, $product_id, $modifier_id, $value_id)
    {
        return $this->updateModifierValueAsyncWithHttpInfo($body, $accept, $content_type, $product_id, $modifier_id, $value_id)
            ->then(
                function ($response) {
                    return $response[0];
                }
     ...
     * @return \GuzzleHttp\Promise\PromiseInterface
     */
    public function updateModifierValueAsyncWithHttpInfo($body, $accept, $content_type, $product_id, $modifier_id, $value_id)
    {
        $returnType = '\BigCommerce\Catalog\Model\ModifierValueResponse';
        $request = $this->updateModifierValueRequest($body, $accept, $content_type, $product_id, $modifier_id, $value_id);
     ...
     * @return \GuzzleHttp\Psr7\Request
     */
    protected function updateModifierValueRequest($body, $accept, $content_type, $product_id, $modifier_id, $value_id)
    {
        // verify the required parameter 'body' is set
        if ($body === null || (is_array($body) && count($body) === 0)) {
            throw new \InvalidArgumentException(
                'Missing the required parameter $body when calling updateModifierValue'
            );
        }
        // verify the required parameter 'accept' is set
        if ($accept === null || (is_array($accept) && count($accept) === 0)) {
