...
class ProductMetafieldsApi
{
     ...
     *
     * @param  \BigCommerce\Catalog\Model\MetafieldPost1 $body body (required)
     ...
     */
    public function createProductMetafield($body, $accept, $content_type, $product_id)
    {
        list($response) = $this->createProductMetafieldWithHttpInfo($body, $accept, $content_type, $product_id);
        return $response;
    }
     ...
     * Create a Product Metafield
     *
     * @param  \BigCommerce\Catalog\Model\MetafieldPost1 $body (required)
     ...
     */
    public function createProductMetafieldWithHttpInfo($body, $accept, $content_type, $product_id)
    {
        $returnType = '\BigCommerce\Catalog\Model\MetafieldResponse1';
        $request = $this->createProductMetafieldRequest($body, $accept, $content_type, $product_id);
     ...
     */
    public function createProductMetafieldAsync($body, $accept, $content_type, $product_id)
    {
        return $this->createProductMetafieldAsyncWithHttpInfo($body, $accept, $content_type, $product_id)
            ->then(
                function ($response) {
                    return $response[0];
                }
     ...
     * @return \GuzzleHttp\Promise\PromiseInterface
     */
    public function createProductMetafieldAsyncWithHttpInfo($body, $accept, $content_type, $product_id)
    {
        $returnType = '\BigCommerce\Catalog\Model\MetafieldResponse1';
        $request = $this->createProductMetafieldRequest($body, $accept, $content_type, $product_id);
     ...
     */
    protected function createProductMetafieldRequest($body, $accept, $content_type, $product_id)
    {
        // verify the required parameter 'body' is set
        if ($body === null || (is_array($body) && count($body) === 0)) {
            throw new \InvalidArgumentException(
                'Missing the required parameter $body when calling createProductMetafield'
            );
        }
     ...
     *
     * @param  \BigCommerce\Catalog\Model\MetafieldPut2 $body body (required)
     * @param  string $accept accept (required)
     * @param  string $content_type content_type (required)
     * @param  int $metafield_id The ID of the &#x60;Metafield&#x60;. (required)
     * @param  int $product_id The ID of the &#x60;Product&#x60; to which the resource belongs. (required)
     ...
     */
    public function updateProductMetafield($body, $accept, $content_type, $metafield_id, $product_id)
    {
        list($response) = $this->updateProductMetafieldWithHttpInfo($body, $accept, $content_type, $metafield_id, $product_id);
        return $response;
    }
     ...
     * Update a Product Metafield
     *
     * @param  \BigCommerce\Catalog\Model\MetafieldPut2 $body (required)
     * @param  string $accept (required)
     * @param  string $content_type (required)
     * @param  int $metafield_id The ID of the &#x60;Metafield&#x60;. (required)
     * @param  int $product_id The ID of the &#x60;Product&#x60; to which the resource belongs. (required)
     ...
     */
    public function updateProductMetafieldWithHttpInfo($body, $accept, $content_type, $metafield_id, $product_id)
    {
        $returnType = '\BigCommerce\Catalog\Model\MetafieldResponse';
        $request = $this->updateProductMetafieldRequest($body, $accept, $content_type, $metafield_id, $product_id);
     ...
     * @return \GuzzleHttp\Promise\PromiseInterface
     */
    public function updateProductMetafieldAsync($body, $accept, $content_type, $metafield_id, $product_id)
    {
        return $this->updateProductMetafieldAsyncWithHttpInfo($body, $accept, $content_type, $metafield_id, $product_id)
            ->then(
                function ($response) {
                    return $response[0];
                }
     ...
     * @return \GuzzleHttp\Promise\PromiseInterface
     */
    public function updateProductMetafieldAsyncWithHttpInfo($body, $accept, $content_type, $metafield_id, $product_id)
    {
        $returnType = '\BigCommerce\Catalog\Model\MetafieldResponse';
        $request = $this->updateProductMetafieldRequest($body, $accept, $content_type, $metafield_id, $product_id);
     ...
     * @return \GuzzleHttp\Psr7\Request
     */
    protected function updateProductMetafieldRequest($body, $accept, $content_type, $metafield_id, $product_id)
    {
        // verify the required parameter 'body' is set
        if ($body === null || (is_array($body) && count($body) === 0)) {
            throw new \InvalidArgumentException(
                'Missing the required parameter $body when calling updateProductMetafield'
            );
        }
        // verify the required parameter 'accept' is set
        if ($accept === null || (is_array($accept) && count($accept) === 0)) {
