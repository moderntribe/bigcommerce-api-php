...
class ProductModifiersApi
{
     ...
     *
     * @param  \BigCommerce\Catalog\Model\ModifierPost $body body (required)
     ...
     * @return \BigCommerce\Catalog\Model\ModifierResponse
     */
    public function createModifier($body, $accept, $content_type, $product_id)
    {
        list($response) = $this->createModifierWithHttpInfo($body, $accept, $content_type, $product_id);
        return $response;
    }
     ...
     * Create a Product Modifier
     *
     * @param  \BigCommerce\Catalog\Model\ModifierPost $body (required)
     ...
     * @throws \BigCommerce\Catalog\ApiException on non-2xx response
     * @throws \InvalidArgumentException
     * @return array of \BigCommerce\Catalog\Model\ModifierResponse, HTTP status code, HTTP response headers (array of strings)
     */
    public function createModifierWithHttpInfo($body, $accept, $content_type, $product_id)
    {
        $returnType = '\BigCommerce\Catalog\Model\ModifierResponse';
        $request = $this->createModifierRequest($body, $accept, $content_type, $product_id);
            ...
            switch ($e->getCode()) {
                case 200:
                    $data = ObjectSerializer::deserialize(
                        $e->getResponseBody(),
                        '\BigCommerce\Catalog\Model\ModifierResponse',
     ...
     */
    public function createModifierAsync($body, $accept, $content_type, $product_id)
    {
        return $this->createModifierAsyncWithHttpInfo($body, $accept, $content_type, $product_id)
            ->then(
                function ($response) {
                    return $response[0];
                }
     ...
     * @return \GuzzleHttp\Promise\PromiseInterface
     */
    public function createModifierAsyncWithHttpInfo($body, $accept, $content_type, $product_id)
    {
        $returnType = '\BigCommerce\Catalog\Model\ModifierResponse';
        $request = $this->createModifierRequest($body, $accept, $content_type, $product_id);
     ...
     */
    protected function createModifierRequest($body, $accept, $content_type, $product_id)
    {
        // verify the required parameter 'body' is set
        if ($body === null || (is_array($body) && count($body) === 0)) {
            throw new \InvalidArgumentException(
                'Missing the required parameter $body when calling createModifier'
            );
        }
     ...
     * @throws \BigCommerce\Catalog\ApiException on non-2xx response
     * @throws \InvalidArgumentException
     * @return \BigCommerce\Catalog\Model\ModifierResponse1
     */
     ...
     * @throws \BigCommerce\Catalog\ApiException on non-2xx response
     * @throws \InvalidArgumentException
     * @return array of \BigCommerce\Catalog\Model\ModifierResponse1, HTTP status code, HTTP response headers (array of strings)
     */
    ...
    {
        $returnType = '\BigCommerce\Catalog\Model\ModifierResponse1';
        ...
        try {
            ...
            switch ($e->getCode()) {
                case 200:
                    $data = ObjectSerializer::deserialize(
                        $e->getResponseBody(),
                        '\BigCommerce\Catalog\Model\ModifierResponse1',
                        $e->getResponseHeaders()
                    );
                    $e->setResponseObject($data);
                    break;
     ...
     * @throws \BigCommerce\Catalog\ApiException on non-2xx response
     * @throws \InvalidArgumentException
     * @return \BigCommerce\Catalog\Model\ModifierCollectionResponse
     */
     ...
     * @throws \BigCommerce\Catalog\ApiException on non-2xx response
     * @throws \InvalidArgumentException
     * @return array of \BigCommerce\Catalog\Model\ModifierCollectionResponse, HTTP status code, HTTP response headers (array of strings)
     */
    ...
    {
        $returnType = '\BigCommerce\Catalog\Model\ModifierCollectionResponse';
        ...
        try {
            ...
            switch ($e->getCode()) {
                case 200:
                    $data = ObjectSerializer::deserialize(
                        $e->getResponseBody(),
                        '\BigCommerce\Catalog\Model\ModifierCollectionResponse',
                        $e->getResponseHeaders()
                    );
                    $e->setResponseObject($data);
                    break;
     ...
     * Update a Modifier
     *
     * @param  \BigCommerce\Catalog\Model\ModifierPut $body body (required)
     * @param  string $accept accept (required)
     * @param  string $content_type content_type (required)
     * @param  int $product_id The ID of the &#x60;Product&#x60; to which the resource belongs. (required)
     * @param  int $modifier_id The ID of the &#x60;Modifier&#x60;. (required)
     ...
     * @return \BigCommerce\Catalog\Model\ModifierResponse
     */
    public function updateModifier($body, $accept, $content_type, $product_id, $modifier_id)
    {
        list($response) = $this->updateModifierWithHttpInfo($body, $accept, $content_type, $product_id, $modifier_id);
        return $response;
    }
     ...
     * Update a Modifier
     *
     * @param  \BigCommerce\Catalog\Model\ModifierPut $body (required)
     * @param  string $accept (required)
     * @param  string $content_type (required)
     * @param  int $product_id The ID of the &#x60;Product&#x60; to which the resource belongs. (required)
     * @param  int $modifier_id The ID of the &#x60;Modifier&#x60;. (required)
     ...
     * @return array of \BigCommerce\Catalog\Model\ModifierResponse, HTTP status code, HTTP response headers (array of strings)
     */
    public function updateModifierWithHttpInfo($body, $accept, $content_type, $product_id, $modifier_id)
    {
        $returnType = '\BigCommerce\Catalog\Model\ModifierResponse';
        $request = $this->updateModifierRequest($body, $accept, $content_type, $product_id, $modifier_id);
     ...
     * @return \GuzzleHttp\Promise\PromiseInterface
     */
    public function updateModifierAsync($body, $accept, $content_type, $product_id, $modifier_id)
    {
        return $this->updateModifierAsyncWithHttpInfo($body, $accept, $content_type, $product_id, $modifier_id)
            ->then(
                function ($response) {
                    return $response[0];
                }
     ...
     * @return \GuzzleHttp\Promise\PromiseInterface
     */
    public function updateModifierAsyncWithHttpInfo($body, $accept, $content_type, $product_id, $modifier_id)
    {
        $returnType = '\BigCommerce\Catalog\Model\ModifierResponse';
        $request = $this->updateModifierRequest($body, $accept, $content_type, $product_id, $modifier_id);
     ...
     * @return \GuzzleHttp\Psr7\Request
     */
    protected function updateModifierRequest($body, $accept, $content_type, $product_id, $modifier_id)
    {
        // verify the required parameter 'body' is set
        if ($body === null || (is_array($body) && count($body) === 0)) {
            throw new \InvalidArgumentException(
                'Missing the required parameter $body when calling updateModifier'
            );
        }
        // verify the required parameter 'accept' is set
        if ($accept === null || (is_array($accept) && count($accept) === 0)) {
