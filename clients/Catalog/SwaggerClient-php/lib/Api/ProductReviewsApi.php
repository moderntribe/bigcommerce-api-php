...
class ProductReviewsApi
{
     ...
     *
     * @param  \BigCommerce\Catalog\Model\ProductReviewPost $body body (required)
     ...
     * @return \BigCommerce\Catalog\Model\ProductReviewResponse
     */
    public function createProductReview($body, $accept, $content_type, $product_id)
    {
        list($response) = $this->createProductReviewWithHttpInfo($body, $accept, $content_type, $product_id);
        return $response;
    }
     ...
     * Create a Product Review
     *
     * @param  \BigCommerce\Catalog\Model\ProductReviewPost $body (required)
     ...
     * @throws \BigCommerce\Catalog\ApiException on non-2xx response
     * @throws \InvalidArgumentException
     * @return array of \BigCommerce\Catalog\Model\ProductReviewResponse, HTTP status code, HTTP response headers (array of strings)
     */
    public function createProductReviewWithHttpInfo($body, $accept, $content_type, $product_id)
    {
        $returnType = '\BigCommerce\Catalog\Model\ProductReviewResponse';
        $request = $this->createProductReviewRequest($body, $accept, $content_type, $product_id);
            ...
            switch ($e->getCode()) {
                case 200:
                    $data = ObjectSerializer::deserialize(
                        $e->getResponseBody(),
                        '\BigCommerce\Catalog\Model\ProductReviewResponse',
     ...
     */
    public function createProductReviewAsync($body, $accept, $content_type, $product_id)
    {
        return $this->createProductReviewAsyncWithHttpInfo($body, $accept, $content_type, $product_id)
            ->then(
                function ($response) {
                    return $response[0];
                }
     ...
     * @return \GuzzleHttp\Promise\PromiseInterface
     */
    public function createProductReviewAsyncWithHttpInfo($body, $accept, $content_type, $product_id)
    {
        $returnType = '\BigCommerce\Catalog\Model\ProductReviewResponse';
        $request = $this->createProductReviewRequest($body, $accept, $content_type, $product_id);
     ...
     */
    protected function createProductReviewRequest($body, $accept, $content_type, $product_id)
    {
        // verify the required parameter 'body' is set
        if ($body === null || (is_array($body) && count($body) === 0)) {
            throw new \InvalidArgumentException(
                'Missing the required parameter $body when calling createProductReview'
            );
        }
     ...
     * @throws \BigCommerce\Catalog\ApiException on non-2xx response
     * @throws \InvalidArgumentException
     * @return \BigCommerce\Catalog\Model\ProductReviewCollectionResponse
     */
     ...
     * @throws \BigCommerce\Catalog\ApiException on non-2xx response
     * @throws \InvalidArgumentException
     * @return array of \BigCommerce\Catalog\Model\ProductReviewCollectionResponse, HTTP status code, HTTP response headers (array of strings)
     */
    ...
    {
        $returnType = '\BigCommerce\Catalog\Model\ProductReviewCollectionResponse';
        ...
        try {
            ...
            switch ($e->getCode()) {
                case 200:
                    $data = ObjectSerializer::deserialize(
                        $e->getResponseBody(),
                        '\BigCommerce\Catalog\Model\ProductReviewCollectionResponse',
                        $e->getResponseHeaders()
                    );
                    $e->setResponseObject($data);
                    break;
     ...
     *
     * @param  \BigCommerce\Catalog\Model\ProductReviewPut $body A BigCommerce &#x60;ProductReview&#x60; object.
 (required)
     * @param  string $accept accept (required)
     * @param  string $content_type content_type (required)
     * @param  int $product_id The ID of the &#x60;Product&#x60; to which the resource belongs. (required)
     ...
     * @return \BigCommerce\Catalog\Model\ProductReviewResponse
     */
    public function updateProductReview($body, $accept, $content_type, $product_id, $review_id)
    {
        list($response) = $this->updateProductReviewWithHttpInfo($body, $accept, $content_type, $product_id, $review_id);
        return $response;
    }
 ...
 (required)
     ...
     * @return array of \BigCommerce\Catalog\Model\ProductReviewResponse, HTTP status code, HTTP response headers (array of strings)
     */
    public function updateProductReviewWithHttpInfo($body, $accept, $content_type, $product_id, $review_id)
    {
        $returnType = '\BigCommerce\Catalog\Model\ProductReviewResponse';
        $request = $this->updateProductReviewRequest($body, $accept, $content_type, $product_id, $review_id);
 ...
 (required)
     ...
     * @return \GuzzleHttp\Promise\PromiseInterface
     */
    public function updateProductReviewAsync($body, $accept, $content_type, $product_id, $review_id)
    {
        return $this->updateProductReviewAsyncWithHttpInfo($body, $accept, $content_type, $product_id, $review_id)
            ->then(
                function ($response) {
                    return $response[0];
                }
 ...
 (required)
     ...
     * @return \GuzzleHttp\Promise\PromiseInterface
     */
    public function updateProductReviewAsyncWithHttpInfo($body, $accept, $content_type, $product_id, $review_id)
    {
        $returnType = '\BigCommerce\Catalog\Model\ProductReviewResponse';
        $request = $this->updateProductReviewRequest($body, $accept, $content_type, $product_id, $review_id);
 ...
 (required)
     ...
     * @return \GuzzleHttp\Psr7\Request
     */
    protected function updateProductReviewRequest($body, $accept, $content_type, $product_id, $review_id)
    {
        // verify the required parameter 'body' is set
        if ($body === null || (is_array($body) && count($body) === 0)) {
            throw new \InvalidArgumentException(
                'Missing the required parameter $body when calling updateProductReview'
            );
        }
        // verify the required parameter 'accept' is set
        if ($accept === null || (is_array($accept) && count($accept) === 0)) {
