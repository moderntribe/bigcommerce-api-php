...
/**
 * AllOfVariantCollectionResponse2DataItems Class Doc Comment
 *
 * @category Class
 * @package  BigCommerce\Catalog
 * @author   Swagger Codegen team
 * @link     https://github.com/swagger-api/swagger-codegen
 */
class AllOfVariantCollectionResponse2DataItems implements ModelInterface, ArrayAccess
{
    ...
    /**
      ...
      * @var string
      */
    protected static $swaggerModelName = 'AllOfVariant Collection Response_2DataItems';
...
'calculated_price' => 'getCalculatedPrice'    ];
     ...
     * Sets option_values
     *
     * @param object[] $option_values Array of option and option values IDs that make up this variant. Will be empty if the variant is the product's base variant.
     *
     * @return $this
     */
