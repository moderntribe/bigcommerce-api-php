...
/**
 * ProductImagePost1 Class Doc Comment
 *
 * @category Class
 ...
 * @link     https://github.com/swagger-api/swagger-codegen
 */
class ProductImagePost1 implements ModelInterface, ArrayAccess
{
    ...
    /**
      ...
      * @var string
      */
    protected static $swaggerModelName = 'Product Image Post_1';
...
'image_file' => 'getImageFile'    ];
     ...
     * Sets image_url
     *
     * @param string $image_url Must be a fully qualified URL path, including protocol. Limit of 8MB per file.
     *
     * @return $this
     */
     ...
     * Sets image_file
     *
     * @param string $image_file Must be sent as a multipart/form-data field in the request body.
     *
     * @return $this
     */
