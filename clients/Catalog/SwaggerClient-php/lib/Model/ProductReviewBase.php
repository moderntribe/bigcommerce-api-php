...
class ProductReviewBase implements ModelInterface, ArrayAccess
{
    ...
    /**
      ...
      * @var string
      */
    protected static $swaggerModelName = 'productReview_Base';
...
'date_reviewed' => 'getDateReviewed'    ];
    ...
    public function listInvalidProperties()
    {
        ...
        if ($this->container['date_reviewed'] === null) {
            $invalidProperties[] = "'date_reviewed' can't be null";
        }
     ...
     * Sets title
     *
     * @param string $title The title for the product review. Required in /POST.
     *
     * @return $this
     */
     ...
     * Sets date_reviewed
     *
     * @param \DateTime $date_reviewed Date the product was reviewed. Required in /POST.
     *
     * @return $this
     */
