...
/**
 * ProductModifierBase Class Doc Comment
 *
 * @category Class
 ...
 * @link     https://github.com/swagger-api/swagger-codegen
 */
class ProductModifierBase implements ModelInterface, ArrayAccess
{
    ...
    /**
      ...
      * @var string
      */
    protected static $swaggerModelName = 'productModifier_Base';
...
'required' => 'bool',
'sort_order' => 'int',
'config' => '\BigCommerce\Catalog\Model\OptionConfig',
'display_name' => 'string'    ];
...
self::TYPE_SWATCH,        ];
     ...
     * Sets type
     *
     * @param string $type BigCommerce API, which determines how it will display on the storefront. Acceptable values: `date`, `checkbox`, `file`, `text`, `multi_line_text`, `numbers_only_text`, `radio_buttons`, `rectangles`, `dropdown`, `product_list`, `product_list_with_images`, `swatch`. Required in a /POST.
     *
     * @return $this
     */
     ...
     * Sets required
     *
     * @param bool $required Whether or not this modifer is required or not at checkout. Required in a /POST.
     *
     * @return $this
     */
     ...
     * Gets config
     *
     * @return \BigCommerce\Catalog\Model\OptionConfig
     */
     ...
     * Sets config
     *
     * @param \BigCommerce\Catalog\Model\OptionConfig $config config
     *
     * @return $this
     */
