...
/**
 * ProductModifierOptionValueBase Class Doc Comment
 *
 * @category Class
 ...
 * @link     https://github.com/swagger-api/swagger-codegen
 */
class ProductModifierOptionValueBase implements ModelInterface, ArrayAccess
{
    ...
    /**
      ...
      * @var string
      */
    protected static $swaggerModelName = 'productModifierOptionValue_Base';
...
'label' => 'string',
'sort_order' => 'int',
'adjusters' => '\BigCommerce\Catalog\Model\AdjustersFull1'    ];
...
'adjusters' => 'getAdjusters'    ];
    ...
    public function __construct(array $data = null)
    {
        ...
        $this->container['adjusters'] = isset($data['adjusters']) ? $data['adjusters'] : null;
    }
     ...
     * Sets label
     *
     * @param string $label The text display identifying the value on the storefront. Required in a /POST.
     *
     * @return $this
     */
     ...
     * Sets sort_order
     *
     * @param int $sort_order The order in which the value will be displayed on the product page. Required in a /POST.
     *
     * @return $this
     */
     ...
     * Gets adjusters
     *
     * @return \BigCommerce\Catalog\Model\AdjustersFull1
     */
     ...
     * Sets adjusters
     *
     * @param \BigCommerce\Catalog\Model\AdjustersFull1 $adjusters adjusters
     *
     * @return $this
     */
