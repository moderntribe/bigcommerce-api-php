...
class Site implements ModelInterface, ArrayAccess
{
    ...
    /**
      ...
      * @var string
      */
    protected static $swaggerModelName = '_site';
...
'created_at' => 'string',
'updated_at' => 'string',
'routes' => '\Swagger\Client\Model\AllOfSiteRoutesItems[]'    ];
...
'routes' => 'getRoutes'    ];
     ...
     * Gets routes
     *
     * @return \Swagger\Client\Model\AllOfSiteRoutesItems[]
     */
     ...
     * Sets routes
     *
     * @param \Swagger\Client\Model\AllOfSiteRoutesItems[] $routes (optional - if included) collection of routes defined for this site. Limited to 200 routes side loaded (query routes direction via `/routes` for bulk)
     *
     * @return $this
     */
