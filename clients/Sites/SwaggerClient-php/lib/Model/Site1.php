 ...
 * @link     https://github.com/swagger-api/swagger-codegen
 */
class Site1 implements ModelInterface, ArrayAccess
{
    ...
    /**
      ...
      * @var string
      */
    protected static $swaggerModelName = '_site_1';
...
'created_at' => 'string',
'updated_at' => 'string',
'routes' => '\Swagger\Client\Model\AllOfSite1RoutesItems[]'    ];
...
'routes' => 'getRoutes'    ];
     ...
     * Gets routes
     *
     * @return \Swagger\Client\Model\AllOfSite1RoutesItems[]
     */
     ...
     * Sets routes
     *
     * @param \Swagger\Client\Model\AllOfSite1RoutesItems[] $routes (optional - if included) collection of routes defined for this site. Limited to 200 routes side loaded (query routes direction via `/routes` for bulk)
     *
     * @return $this
     */
