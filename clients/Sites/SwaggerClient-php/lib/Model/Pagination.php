...
class Pagination implements ModelInterface, ArrayAccess
{
    ...
    /**
      ...
      * @var string
      */
    protected static $swaggerModelName = '_pagination';
...
'current_page' => 'int',
'total_pages' => 'int',
'links' => '\Swagger\Client\Model\PaginationLinks'    ];
...
'links' => 'getLinks'    ];
     ...
     * Gets links
     *
     * @return \Swagger\Client\Model\PaginationLinks
     */
     ...
     * Sets links
     *
     * @param \Swagger\Client\Model\PaginationLinks $links links
     *
     * @return $this
     */
