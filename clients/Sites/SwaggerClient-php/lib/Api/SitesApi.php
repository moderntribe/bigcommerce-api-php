...
class SitesApi
{
    ...
    {
        $this->deleteSiteWithHttpInfo($site_id);
    }
     ...
     */
    public function deleteSiteWithHttpInfo($site_id)
    {
        $returnType = '';
        $request = $this->deleteSiteRequest($site_id);
     ...
     */
    public function deleteSiteAsync($site_id)
    {
        return $this->deleteSiteAsyncWithHttpInfo($site_id)
            ->then(
                function ($response) {
                    return $response[0];
                }
     ...
     * @return \GuzzleHttp\Promise\PromiseInterface
     */
    public function deleteSiteAsyncWithHttpInfo($site_id)
    {
        $returnType = '';
        $request = $this->deleteSiteRequest($site_id);
     ...
     */
    protected function deleteSiteRequest($site_id)
    {
        // verify the required parameter 'site_id' is set
        if ($site_id === null || (is_array($site_id) && count($site_id) === 0)) {
            throw new \InvalidArgumentException(
                'Missing the required parameter $site_id when calling deleteSite'
            );
        }
    ...
    public function getSiteWithHttpInfo($site_id)
    {
        ...
        $request = $this->getSiteRequest($site_id);
     ...
     * @return \GuzzleHttp\Promise\PromiseInterface
     */
    public function getSiteAsync($site_id)
    {
        return $this->getSiteAsyncWithHttpInfo($site_id)
            ->then(
                function ($response) {
                    return $response[0];
                }
     ...
     * @return \GuzzleHttp\Promise\PromiseInterface
     */
    public function getSiteAsyncWithHttpInfo($site_id)
    {
        $returnType = '\Swagger\Client\Model\InlineResponse201';
        $request = $this->getSiteRequest($site_id);
     ...
     * @return \GuzzleHttp\Psr7\Request
     */
    protected function getSiteRequest($site_id)
    {
        // verify the required parameter 'site_id' is set
        if ($site_id === null || (is_array($site_id) && count($site_id) === 0)) {
            throw new \InvalidArgumentException(
                'Missing the required parameter $site_id when calling getSite'
            );
        }
     ...
     * Create a Site
     *
     * @param  \Swagger\Client\Model\PostSite1 $body body (required)
     *
     * @throws \Swagger\Client\ApiException on non-2xx response
     * @throws \InvalidArgumentException
     * @return \Swagger\Client\Model\InlineResponse201
     ...
     * Create a Site
     *
     * @param  \Swagger\Client\Model\PostSite1 $body (required)
     *
     * @throws \Swagger\Client\ApiException on non-2xx response
     * @throws \InvalidArgumentException
     * @return array of \Swagger\Client\Model\InlineResponse201, HTTP status code, HTTP response headers (array of strings)
     ...
     * Update a Site
     *
     * @param  \Swagger\Client\Model\PutSite1 $body body (required)
     * @param  string $site_id site_id (required)
     *
     * @throws \Swagger\Client\ApiException on non-2xx response
     * @throws \InvalidArgumentException
     * @return \Swagger\Client\Model\InlineResponse201
     */
    public function putSite($body, $site_id)
    {
        list($response) = $this->putSiteWithHttpInfo($body, $site_id);
        return $response;
    }
     ...
     * Update a Site
     *
     * @param  \Swagger\Client\Model\PutSite1 $body (required)
     * @param  string $site_id (required)
     *
     * @throws \Swagger\Client\ApiException on non-2xx response
     * @throws \InvalidArgumentException
     * @return array of \Swagger\Client\Model\InlineResponse201, HTTP status code, HTTP response headers (array of strings)
     */
    public function putSiteWithHttpInfo($body, $site_id)
    {
        $returnType = '\Swagger\Client\Model\InlineResponse201';
        $request = $this->putSiteRequest($body, $site_id);
     ...
     * @return \GuzzleHttp\Promise\PromiseInterface
     */
    public function putSiteAsync($body, $site_id)
    {
        return $this->putSiteAsyncWithHttpInfo($body, $site_id)
            ->then(
                function ($response) {
                    return $response[0];
                }
     ...
     * @return \GuzzleHttp\Promise\PromiseInterface
     */
    public function putSiteAsyncWithHttpInfo($body, $site_id)
    {
        $returnType = '\Swagger\Client\Model\InlineResponse201';
        $request = $this->putSiteRequest($body, $site_id);
     ...
     * @return \GuzzleHttp\Psr7\Request
     */
    protected function putSiteRequest($body, $site_id)
    {
        // verify the required parameter 'body' is set
        if ($body === null || (is_array($body) && count($body) === 0)) {
            throw new \InvalidArgumentException(
        ...
        if ($site_id === null || (is_array($site_id) && count($site_id) === 0)) {
            throw new \InvalidArgumentException(
                'Missing the required parameter $site_id when calling putSite'
            );
        }
     ...
     */
    public function sitesGet($page, $limit)
    {
        list($response) = $this->sitesGetWithHttpInfo($page, $limit);
        return $response;
    }
     ...
     */
    public function sitesGetWithHttpInfo($page, $limit)
    {
        $returnType = '\Swagger\Client\Model\InlineResponse200';
        $request = $this->sitesGetRequest($page, $limit);
     ...
     * @return \GuzzleHttp\Promise\PromiseInterface
     */
    public function sitesGetAsync($page, $limit)
    {
        return $this->sitesGetAsyncWithHttpInfo($page, $limit)
            ->then(
                function ($response) {
                    return $response[0];
                }
    ...
    /**
     * Operation sitesGetAsyncWithHttpInfo
     *
     * Get Sites
     *
     * @param  int $page (required)
     ...
     * @return \GuzzleHttp\Promise\PromiseInterface
     */
    public function sitesGetAsyncWithHttpInfo($page, $limit)
    {
        $returnType = '\Swagger\Client\Model\InlineResponse200';
        $request = $this->sitesGetRequest($page, $limit);
    ...
    /**
     * Create request for operation 'sitesGet'
     *
     * @param  int $page (required)
     * @param  int $limit (required)
     *
     ...
     * @return \GuzzleHttp\Psr7\Request
     */
    protected function sitesGetRequest($page, $limit)
    {
        // verify the required parameter 'page' is set
        if ($page === null || (is_array($page) && count($page) === 0)) {
            throw new \InvalidArgumentException(
                'Missing the required parameter $page when calling sitesGet'
            );
        }
        // verify the required parameter 'limit' is set
        if ($limit === null || (is_array($limit) && count($limit) === 0)) {
            throw new \InvalidArgumentException(
                'Missing the required parameter $limit when calling sitesGet'
            );
        }
